...
namespace Naos.HubSpot.Domain
{
    ...
    [Serializable]
    public partial class CompanyModel : IModel<CompanyModel>
    {
        /// <summary>
        /// Determines whether two objects of type <see cref="CompanyModel"/> are equal.
        /// </summary>
        ...
        /// <summary>
        /// Determines whether two objects of type <see cref="CompanyModel"/> are not equal.
        /// </summary>
        /// <param name="left">The object to the left of the equality operator.</param>
        /// <param name="right">The object to the right of the equality operator.</param>
        ...
        /// <inheritdoc />
        public override bool Equals(object obj) => this == (obj as CompanyModel);
        ...
        /// <returns>New <see cref="CompanyModel" /> using the specified <paramref name="createdAt" /> for <see cref="CreatedAt" /> and a deep clone of every other property.</returns>
        ...
        public CompanyModel DeepCloneWithCreatedAt(string createdAt)
        {
            var result = new CompanyModel(
                                 createdAt,
                                 this.UpdatedAt?.Clone().ToString(),
        ...
        /// <returns>New <see cref="CompanyModel" /> using the specified <paramref name="updatedAt" /> for <see cref="UpdatedAt" /> and a deep clone of every other property.</returns>
        [SuppressMessage("Microsoft.Design", "CA1002: DoNotExposeGenericLists")]
        [SuppressMessage("Microsoft.Naming", "CA1702:CompoundWordsShouldBeCasedCorrectly")]
        [SuppressMessage("Microsoft.Naming", "CA1704:IdentifiersShouldBeSpelledCorrectly")]
        [SuppressMessage("Microsoft.Naming", "CA1709:IdentifiersShouldBeCasedCorrectly")]
        ...
        [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
        [SuppressMessage("Microsoft.Performance", "CA1822:MarkMembersAsStatic")]
        public CompanyModel DeepCloneWithUpdatedAt(string updatedAt)
        {
            var result = new CompanyModel(
                                 this.CreatedAt?.Clone().ToString(),
                                 updatedAt,
        ...
        /// <returns>New <see cref="CompanyModel" /> using the specified <paramref name="archived" /> for <see cref="Archived" /> and a deep clone of every other property.</returns>
        [SuppressMessage("Microsoft.Design", "CA1002: DoNotExposeGenericLists")]
        [SuppressMessage("Microsoft.Naming", "CA1702:CompoundWordsShouldBeCasedCorrectly")]
        [SuppressMessage("Microsoft.Naming", "CA1704:IdentifiersShouldBeSpelledCorrectly")]
        [SuppressMessage("Microsoft.Naming", "CA1709:IdentifiersShouldBeCasedCorrectly")]
        ...
        [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
        [SuppressMessage("Microsoft.Performance", "CA1822:MarkMembersAsStatic")]
        public CompanyModel DeepCloneWithArchived(bool archived)
        {
            var result = new CompanyModel(
                                 this.CreatedAt?.Clone().ToString(),
                                 this.UpdatedAt?.Clone().ToString(),
        ...
        /// <returns>New <see cref="CompanyModel" /> using the specified <paramref name="id" /> for <see cref="Id" /> and a deep clone of every other property.</returns>
        [SuppressMessage("Microsoft.Design", "CA1002: DoNotExposeGenericLists")]
        [SuppressMessage("Microsoft.Naming", "CA1702:CompoundWordsShouldBeCasedCorrectly")]
        [SuppressMessage("Microsoft.Naming", "CA1704:IdentifiersShouldBeSpelledCorrectly")]
        [SuppressMessage("Microsoft.Naming", "CA1709:IdentifiersShouldBeCasedCorrectly")]
        ...
        [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
        [SuppressMessage("Microsoft.Performance", "CA1822:MarkMembersAsStatic")]
        public CompanyModel DeepCloneWithId(string id)
        {
            var result = new CompanyModel(
                                 this.CreatedAt?.Clone().ToString(),
                                 this.UpdatedAt?.Clone().ToString(),
        ...
        /// <returns>New <see cref="CompanyModel" /> using the specified <paramref name="properties" /> for <see cref="Properties" /> and a deep clone of every other property.</returns>
        [SuppressMessage("Microsoft.Design", "CA1002: DoNotExposeGenericLists")]
        [SuppressMessage("Microsoft.Naming", "CA1702:CompoundWordsShouldBeCasedCorrectly")]
        [SuppressMessage("Microsoft.Naming", "CA1704:IdentifiersShouldBeSpelledCorrectly")]
        [SuppressMessage("Microsoft.Naming", "CA1709:IdentifiersShouldBeCasedCorrectly")]
        ...
        [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
        [SuppressMessage("Microsoft.Performance", "CA1822:MarkMembersAsStatic")]
        public CompanyModel DeepCloneWithProperties(IReadOnlyDictionary<string, string> properties)
        {
            var result = new CompanyModel(
                                 this.CreatedAt?.Clone().ToString(),
                                 this.UpdatedAt?.Clone().ToString(),
