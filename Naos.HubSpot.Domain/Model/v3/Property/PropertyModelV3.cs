...
namespace Naos.HubSpot.Domain
{
    ...
    public partial class PropertyModelV3 : IModelViaCodeGen
    {
        ...
        public PropertyModelV3(string groupName, bool hidden, ModificationMetadataModel modificationMetadataModel, string name, long displayOrder, IReadOnlyCollection<OptionModel> options, string label, string type, bool hasUniqueValue, string fieldType, bool formField)
        {
