...
namespace Naos.HubSpot.Domain
{
    ...
    [Serializable]
    public partial class ContactModel : IModel<ContactModel>
    {
        /// <summary>
        /// Determines whether two objects of type <see cref="ContactModel"/> are equal.
        /// </summary>
        ...
        /// <summary>
        /// Determines whether two objects of type <see cref="ContactModel"/> are not equal.
        /// </summary>
        /// <param name="left">The object to the left of the equality operator.</param>
        /// <param name="right">The object to the right of the equality operator.</param>
        /// <returns>true if the two items are not equal; otherwise false.</returns>
        public static bool operator !=(ContactModel left, ContactModel right) => !(left == right);
        ...
        /// <inheritdoc />
        public override bool Equals(object obj) => this == (obj as ContactModel);
        ...
        /// <returns>New <see cref="ContactModel" /> using the specified <paramref name="createdAt" /> for <see cref="CreatedAt" /> and a deep clone of every other property.</returns>
        ...
        public ContactModel DeepCloneWithCreatedAt(string createdAt)
        {
            var result = new ContactModel(
                                 createdAt,
                                 this.UpdatedAt?.Clone().ToString(),
        ...
        /// <returns>New <see cref="ContactModel" /> using the specified <paramref name="updatedAt" /> for <see cref="UpdatedAt" /> and a deep clone of every other property.</returns>
        [SuppressMessage("Microsoft.Design", "CA1002: DoNotExposeGenericLists")]
        [SuppressMessage("Microsoft.Naming", "CA1702:CompoundWordsShouldBeCasedCorrectly")]
        [SuppressMessage("Microsoft.Naming", "CA1704:IdentifiersShouldBeSpelledCorrectly")]
        [SuppressMessage("Microsoft.Naming", "CA1709:IdentifiersShouldBeCasedCorrectly")]
        ...
        [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
        [SuppressMessage("Microsoft.Performance", "CA1822:MarkMembersAsStatic")]
        public ContactModel DeepCloneWithUpdatedAt(string updatedAt)
        {
            var result = new ContactModel(
                                 this.CreatedAt?.Clone().ToString(),
                                 updatedAt,
        ...
        /// <returns>New <see cref="ContactModel" /> using the specified <paramref name="archived" /> for <see cref="Archived" /> and a deep clone of every other property.</returns>
        [SuppressMessage("Microsoft.Design", "CA1002: DoNotExposeGenericLists")]
        [SuppressMessage("Microsoft.Naming", "CA1702:CompoundWordsShouldBeCasedCorrectly")]
        [SuppressMessage("Microsoft.Naming", "CA1704:IdentifiersShouldBeSpelledCorrectly")]
        [SuppressMessage("Microsoft.Naming", "CA1709:IdentifiersShouldBeCasedCorrectly")]
        ...
        [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
        [SuppressMessage("Microsoft.Performance", "CA1822:MarkMembersAsStatic")]
        public ContactModel DeepCloneWithArchived(bool archived)
        {
            var result = new ContactModel(
                                 this.CreatedAt?.Clone().ToString(),
                                 this.UpdatedAt?.Clone().ToString(),
        ...
        /// <returns>New <see cref="ContactModel" /> using the specified <paramref name="id" /> for <see cref="Id" /> and a deep clone of every other property.</returns>
        [SuppressMessage("Microsoft.Design", "CA1002: DoNotExposeGenericLists")]
        [SuppressMessage("Microsoft.Naming", "CA1702:CompoundWordsShouldBeCasedCorrectly")]
        [SuppressMessage("Microsoft.Naming", "CA1704:IdentifiersShouldBeSpelledCorrectly")]
        [SuppressMessage("Microsoft.Naming", "CA1709:IdentifiersShouldBeCasedCorrectly")]
        ...
        [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
        [SuppressMessage("Microsoft.Performance", "CA1822:MarkMembersAsStatic")]
        public ContactModel DeepCloneWithId(string id)
        {
            var result = new ContactModel(
                                 this.CreatedAt?.Clone().ToString(),
                                 this.UpdatedAt?.Clone().ToString(),
        ...
        /// <returns>New <see cref="ContactModel" /> using the specified <paramref name="properties" /> for <see cref="Properties" /> and a deep clone of every other property.</returns>
        [SuppressMessage("Microsoft.Design", "CA1002: DoNotExposeGenericLists")]
        [SuppressMessage("Microsoft.Naming", "CA1702:CompoundWordsShouldBeCasedCorrectly")]
        [SuppressMessage("Microsoft.Naming", "CA1704:IdentifiersShouldBeSpelledCorrectly")]
        [SuppressMessage("Microsoft.Naming", "CA1709:IdentifiersShouldBeCasedCorrectly")]
        ...
        [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
        [SuppressMessage("Microsoft.Performance", "CA1822:MarkMembersAsStatic")]
        public ContactModel DeepCloneWithProperties(IReadOnlyDictionary<string, string> properties)
        {
            var result = new ContactModel(
                                 this.CreatedAt?.Clone().ToString(),
                                 this.UpdatedAt?.Clone().ToString(),
