...
namespace Naos.HubSpot.Domain.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<GetAllContactsOp> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<GetAllContactsOp>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<GetAllContactsOp>
                {
                    Name = "Default Code Generated Scenario",
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<GetAllContactsOp>();

                        var result = new SystemUnderTestExpectedStringRepresentation<GetAllContactsOp>
                        {
                            SystemUnderTest = systemUnderTest,
                            ExpectedStringRepresentation = Invariant($"Naos.HubSpot.Domain.GetAllContactsOp: PropertyNamesToInclude = {systemUnderTest.PropertyNamesToInclude?.ToString() ?? "<null>"}."),
                        };
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<GetAllContactsOp> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<GetAllContactsOp>()
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<GetAllContactsOp>
                {
            ...
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<GetAllContactsOp>
                {
                    ...
                    ConstructionFunc = () =>
                    {
                        var referenceObject = A.Dummy<GetAllContactsOp>();
        ...
        private static readonly ConstructorPropertyAssignmentTestScenarios<GetAllContactsOp> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<GetAllContactsOp>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<GetAllContactsOp>
                {
                    ...
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        ...
                        var result = new SystemUnderTestExpectedPropertyValue<GetAllContactsOp>
                        {
                            SystemUnderTest = new GetAllContactsOp(
        ...
        private static readonly DeepCloneWithTestScenarios<GetAllContactsOp> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<GetAllContactsOp>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<GetAllContactsOp>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<GetAllContactsOp>().ThatIs(_ => !systemUnderTest.PropertyNamesToInclude.IsEqualTo(_.PropertyNamesToInclude));

                        var result = new SystemUnderTestDeepCloneWithValue<GetAllContactsOp>
                        {
                            SystemUnderTest = systemUnderTest,
        ...
        private static readonly GetAllContactsOp ReferenceObjectForEquatableTestScenarios = A.Dummy<GetAllContactsOp>();

        private static readonly EquatableTestScenarios<GetAllContactsOp> EquatableTestScenarios = new EquatableTestScenarios<GetAllContactsOp>()
            .AddScenario(() =>
                new EquatableTestScenario<GetAllContactsOp>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new GetAllContactsOp[]
                    {
                        new GetAllContactsOp(
                                ReferenceObjectForEquatableTestScenarios.PropertyNamesToInclude),
                    },
                    ObjectsThatAreNotEqualToReferenceObject = new GetAllContactsOp[]
                    {
                        new GetAllContactsOp(
                                A.Dummy<GetAllContactsOp>().Whose(_ => !_.PropertyNamesToInclude.IsEqualTo(ReferenceObjectForEquatableTestScenarios.PropertyNamesToInclude)).PropertyNamesToInclude),
                    },
        ...
        public static class Structural
        {
            ...
            public static void GetAllContactsOp___Should_implement_IModel_of_GetAllContactsOp___When_reflecting()
            {
                // Arrange
                var type = typeof(GetAllContactsOp);

                var expectedModelMethods = typeof(IModel<GetAllContactsOp>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<GetAllContactsOp>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void GetAllContactsOp___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(GetAllContactsOp);
        ...
        public static class Cloning
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (GetAllContactsOp)systemUnderTest.Clone();
            ...
            public static void DeepCloneWith___Should_deep_clone_object_and_replace_the_associated_property_with_the_provided_value___When_called()
            {
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (GetAllContactsOp)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach(var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(GetAllContactsOp).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class Serialization
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<GetAllContactsOp>();
        ...
        public static class Equality
        {
            ...
            {
                // Arrange
                GetAllContactsOp systemUnderTest1 = null;
                GetAllContactsOp systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    GetAllContactsOp systemUnderTest = null;
            ...
            public static void Equals_with_ReturningOperationBase___Should_return_false___When_parameter_other_is_null()
            {
                ...
                {
                    // Arrange
                    ReturningOperationBase<IReadOnlyCollection<Contact>> systemUnderTest = null;

                    // Act
                    var actual = scenario.ReferenceObject.Equals((ReturningOperationBase<IReadOnlyCollection<Contact>>)systemUnderTest);
            ...
            public static void Equals_with_ReturningOperationBase___Should_return_true___When_parameter_other_is_same_object()
            {
                ...
                {
                    // Arrange, Act
                    var actual = scenario.ReferenceObject.Equals((ReturningOperationBase<IReadOnlyCollection<Contact>>)scenario.ReferenceObject);
            ...
            public static void Equals_with_ReturningOperationBase___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                ...
                {
                    // Arrange, Act
                    var actuals = scenario.ObjectsThatDeriveFromScenarioTypeButAreNotOfTheSameTypeAsReferenceObject.Select(_ => scenario.ReferenceObject.Equals((ReturningOperationBase<IReadOnlyCollection<Contact>>)_)).ToList();
            ...
            public static void Equals_with_ReturningOperationBase___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                ...
                {
                    // Arrange, Act
                    var actuals = scenario.ObjectsThatAreNotEqualToReferenceObject.Select(_ => scenario.ReferenceObject.Equals((ReturningOperationBase<IReadOnlyCollection<Contact>>)_)).ToList();
            ...
            public static void Equals_with_ReturningOperationBase___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                ...
                {
                    // Arrange, Act
                    var actuals = scenario.ObjectsThatAreEqualToButNotTheSameAsReferenceObject.Select(_ => scenario.ReferenceObject.Equals((ReturningOperationBase<IReadOnlyCollection<Contact>>)_)).ToList();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_GetAllContactsOp___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_GetAllContactsOp___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_GetAllContactsOp___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_GetAllContactsOp___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_GetAllContactsOp___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
