...
namespace Naos.HubSpot.Domain.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<CreateCompanyPropertyOp> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<CreateCompanyPropertyOp>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<CreateCompanyPropertyOp>
                {
                    Name = "Default Code Generated Scenario",
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<CreateCompanyPropertyOp>();

                        var result = new SystemUnderTestExpectedStringRepresentation<CreateCompanyPropertyOp>
                        {
                            SystemUnderTest = systemUnderTest,
                            ExpectedStringRepresentation = Invariant($"Naos.HubSpot.Domain.CreateCompanyPropertyOp: Request = {systemUnderTest.Request?.ToString() ?? "<null>"}."),
                        };
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<CreateCompanyPropertyOp> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<CreateCompanyPropertyOp>()
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<CreateCompanyPropertyOp>
                {
                    Name = "constructor should throw ArgumentNullException when parameter 'request' is null scenario",
                    ConstructionFunc = () =>
                    {
                    ...
                    ExpectedExceptionMessageContains = new[] { "request" },
                });

        private static readonly ConstructorPropertyAssignmentTestScenarios<CreateCompanyPropertyOp> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<CreateCompanyPropertyOp>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<CreateCompanyPropertyOp>
                {
                    Name = "Request should return same 'request' parameter passed to constructor when getting",
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        var referenceObject = A.Dummy<CreateCompanyPropertyOp>();

                        var result = new SystemUnderTestExpectedPropertyValue<CreateCompanyPropertyOp>
                        {
                            SystemUnderTest = new CreateCompanyPropertyOp(
                                                      referenceObject.Request),
                            ExpectedPropertyValue = referenceObject.Request,
                        };
        ...
        private static readonly DeepCloneWithTestScenarios<CreateCompanyPropertyOp> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<CreateCompanyPropertyOp>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<CreateCompanyPropertyOp>
                {
                    Name = "DeepCloneWithRequest should deep clone object and replace Request with the provided request",
                    WithPropertyName = "Request",
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<CreateCompanyPropertyOp>();

                        var referenceObject = A.Dummy<CreateCompanyPropertyOp>().ThatIs(_ => !systemUnderTest.Request.IsEqualTo(_.Request));

                        var result = new SystemUnderTestDeepCloneWithValue<CreateCompanyPropertyOp>
                        {
                            SystemUnderTest = systemUnderTest,
                            DeepCloneWithValue = referenceObject.Request,
                        };
        ...
        private static readonly CreateCompanyPropertyOp ReferenceObjectForEquatableTestScenarios = A.Dummy<CreateCompanyPropertyOp>();

        private static readonly EquatableTestScenarios<CreateCompanyPropertyOp> EquatableTestScenarios = new EquatableTestScenarios<CreateCompanyPropertyOp>()
            .AddScenario(() =>
                new EquatableTestScenario<CreateCompanyPropertyOp>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new CreateCompanyPropertyOp[]
                    {
                        new CreateCompanyPropertyOp(
                                ReferenceObjectForEquatableTestScenarios.Request),
                    },
                    ObjectsThatAreNotEqualToReferenceObject = new CreateCompanyPropertyOp[]
                    {
                        new CreateCompanyPropertyOp(
                                A.Dummy<CreateCompanyPropertyOp>().Whose(_ => !_.Request.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Request)).Request),
                    },
        ...
        public static class Structural
        {
            ...
            public static void CreateCompanyPropertyOp___Should_implement_IModel_of_CreateCompanyPropertyOp___When_reflecting()
            {
                // Arrange
                var type = typeof(CreateCompanyPropertyOp);

                var expectedModelMethods = typeof(IModel<CreateCompanyPropertyOp>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<CreateCompanyPropertyOp>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void CreateCompanyPropertyOp___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(CreateCompanyPropertyOp);
        ...
        public static class Cloning
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (CreateCompanyPropertyOp)systemUnderTest.Clone();
            ...
            public static void DeepClone___Should_deep_clone_object___When_called()
            {
                ...
                if (systemUnderTest.Request == null)
                {
                    actual.Request.AsTest().Must().BeNull();
                }
                else
                {
                    actual.Request.AsTest().Must().NotBeSameReferenceAs(systemUnderTest.Request);
                }
            }
            ...
            {
                var propertyNames = new string[] { "Request" };
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (CreateCompanyPropertyOp)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach(var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(CreateCompanyPropertyOp).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class Serialization
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<CreateCompanyPropertyOp>();
        ...
        public static class Equality
        {
            ...
            {
                // Arrange
                CreateCompanyPropertyOp systemUnderTest1 = null;
                CreateCompanyPropertyOp systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    CreateCompanyPropertyOp systemUnderTest = null;
            ...
            public static void Equals_with_ReturningOperationBase___Should_return_false___When_parameter_other_is_null()
            {
                ...
                {
                    // Arrange
                    ReturningOperationBase<GetAllCompanyPropertiesResponse> systemUnderTest = null;

                    // Act
                    var actual = scenario.ReferenceObject.Equals((ReturningOperationBase<GetAllCompanyPropertiesResponse>)systemUnderTest);
            ...
            public static void Equals_with_ReturningOperationBase___Should_return_true___When_parameter_other_is_same_object()
            {
                ...
                {
                    // Arrange, Act
                    var actual = scenario.ReferenceObject.Equals((ReturningOperationBase<GetAllCompanyPropertiesResponse>)scenario.ReferenceObject);
            ...
            public static void Equals_with_ReturningOperationBase___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                ...
                {
                    // Arrange, Act
                    var actuals = scenario.ObjectsThatDeriveFromScenarioTypeButAreNotOfTheSameTypeAsReferenceObject.Select(_ => scenario.ReferenceObject.Equals((ReturningOperationBase<GetAllCompanyPropertiesResponse>)_)).ToList();
            ...
            public static void Equals_with_ReturningOperationBase___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                ...
                {
                    // Arrange, Act
                    var actuals = scenario.ObjectsThatAreNotEqualToReferenceObject.Select(_ => scenario.ReferenceObject.Equals((ReturningOperationBase<GetAllCompanyPropertiesResponse>)_)).ToList();
            ...
            public static void Equals_with_ReturningOperationBase___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                ...
                {
                    // Arrange, Act
                    var actuals = scenario.ObjectsThatAreEqualToButNotTheSameAsReferenceObject.Select(_ => scenario.ReferenceObject.Equals((ReturningOperationBase<GetAllCompanyPropertiesResponse>)_)).ToList();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_CreateCompanyPropertyOp___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_CreateCompanyPropertyOp___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_CreateCompanyPropertyOp___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_CreateCompanyPropertyOp___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_CreateCompanyPropertyOp___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
