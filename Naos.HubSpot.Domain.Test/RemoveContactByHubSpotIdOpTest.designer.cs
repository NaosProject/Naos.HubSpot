...
namespace Naos.HubSpot.Domain.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<RemoveContactByHubSpotIdOp> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<RemoveContactByHubSpotIdOp>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<RemoveContactByHubSpotIdOp>
                {
                    Name = "Default Code Generated Scenario",
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<RemoveContactByHubSpotIdOp>();

                        var result = new SystemUnderTestExpectedStringRepresentation<RemoveContactByHubSpotIdOp>
                        {
                            SystemUnderTest = systemUnderTest,
                            ExpectedStringRepresentation = Invariant($"Naos.HubSpot.Domain.RemoveContactByHubSpotIdOp: HubSpotId = {systemUnderTest.HubSpotId?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}."),
                        };
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<RemoveContactByHubSpotIdOp> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<RemoveContactByHubSpotIdOp>()
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<RemoveContactByHubSpotIdOp>
                {
                    Name = "constructor should throw ArgumentNullException when parameter 'hubSpotId' is null scenario",
                    ConstructionFunc = () =>
                    {
                        var result = new RemoveContactByHubSpotIdOp(
                                             null);
        ...
        private static readonly ConstructorPropertyAssignmentTestScenarios<RemoveContactByHubSpotIdOp> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<RemoveContactByHubSpotIdOp>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<RemoveContactByHubSpotIdOp>
                {
                    Name = "HubSpotId should return same 'hubSpotId' parameter passed to constructor when getting",
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        var referenceObject = A.Dummy<RemoveContactByHubSpotIdOp>();

                        var result = new SystemUnderTestExpectedPropertyValue<RemoveContactByHubSpotIdOp>
                        {
                            SystemUnderTest = new RemoveContactByHubSpotIdOp(
        ...
        private static readonly DeepCloneWithTestScenarios<RemoveContactByHubSpotIdOp> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<RemoveContactByHubSpotIdOp>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<RemoveContactByHubSpotIdOp>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<RemoveContactByHubSpotIdOp>().ThatIs(_ => !systemUnderTest.HubSpotId.IsEqualTo(_.HubSpotId));

                        var result = new SystemUnderTestDeepCloneWithValue<RemoveContactByHubSpotIdOp>
                        {
                            SystemUnderTest = systemUnderTest,
        ...
        private static readonly RemoveContactByHubSpotIdOp ReferenceObjectForEquatableTestScenarios = A.Dummy<RemoveContactByHubSpotIdOp>();

        private static readonly EquatableTestScenarios<RemoveContactByHubSpotIdOp> EquatableTestScenarios = new EquatableTestScenarios<RemoveContactByHubSpotIdOp>()
            .AddScenario(() =>
                new EquatableTestScenario<RemoveContactByHubSpotIdOp>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new RemoveContactByHubSpotIdOp[]
                    {
                        new RemoveContactByHubSpotIdOp(
                                ReferenceObjectForEquatableTestScenarios.HubSpotId),
                    },
                    ObjectsThatAreNotEqualToReferenceObject = new RemoveContactByHubSpotIdOp[]
                    {
                        new RemoveContactByHubSpotIdOp(
                                A.Dummy<RemoveContactByHubSpotIdOp>().Whose(_ => !_.HubSpotId.IsEqualTo(ReferenceObjectForEquatableTestScenarios.HubSpotId)).HubSpotId),
                    },
        ...
        public static class Structural
        {
            ...
            {
                // Arrange
                var type = typeof(RemoveContactByHubSpotIdOp);

                var expectedModelMethods = typeof(IModel<RemoveContactByHubSpotIdOp>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<RemoveContactByHubSpotIdOp>));
        ...
        public static class Cloning
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (RemoveContactByHubSpotIdOp)systemUnderTest.Clone();
            ...
            public static void DeepCloneWith___Should_deep_clone_object_and_replace_the_associated_property_with_the_provided_value___When_called()
            {
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (RemoveContactByHubSpotIdOp)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach(var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(RemoveContactByHubSpotIdOp).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class Serialization
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<RemoveContactByHubSpotIdOp>();
        ...
        public static class Equality
        {
            ...
            {
                // Arrange
                RemoveContactByHubSpotIdOp systemUnderTest1 = null;
                RemoveContactByHubSpotIdOp systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    RemoveContactByHubSpotIdOp systemUnderTest = null;
