...
namespace Naos.HubSpot.Domain.Test
{
    ...
    public static partial class ContactTest
    {
        ...
        private static readonly StringRepresentationTestScenarios<Contact> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<Contact>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<Contact>
                {
                    Name = "Default Code Generated Scenario",
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<Contact>();

                        var result = new SystemUnderTestExpectedStringRepresentation<Contact>
                        {
                            SystemUnderTest = systemUnderTest,
                            ExpectedStringRepresentation = Invariant($"Naos.HubSpot.Domain.Contact: Email = {systemUnderTest.Email?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}, Vid = {systemUnderTest.Vid?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}, Properties = {systemUnderTest.Properties?.ToString() ?? "<null>"}."),
                        };
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<Contact> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<Contact>()
            .AddScenario(() =>
            ...
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<Contact>
                {
                    Name = "constructor should throw ArgumentNullException when parameter 'vid' is null scenario",
                    ConstructionFunc = () =>
                    {
                        var referenceObject = A.Dummy<Contact>();
                    ...
                    ExpectedExceptionType = typeof(ArgumentNullException),
                    ExpectedExceptionMessageContains = new[] { "vid" },
                })
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<Contact>
                {
        ...
        private static readonly ConstructorPropertyAssignmentTestScenarios<Contact> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<Contact>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<Contact>
                {
        ...
        private static readonly DeepCloneWithTestScenarios<Contact> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<Contact>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<Contact>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<Contact>().ThatIs(_ => !systemUnderTest.Email.IsEqualTo(_.Email));

                        var result = new SystemUnderTestDeepCloneWithValue<Contact>
                        {
                            SystemUnderTest = systemUnderTest,
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<Contact>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<Contact>().ThatIs(_ => !systemUnderTest.Vid.IsEqualTo(_.Vid));
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<Contact>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<Contact>().ThatIs(_ => !systemUnderTest.Properties.IsEqualTo(_.Properties));
        ...
        public static class Structural
        {
            ...
            public static void Contact___Should_implement_IModel_of_Contact___When_reflecting()
            {
                // Arrange
                var type = typeof(Contact);

                var expectedModelMethods = typeof(IModel<Contact>)
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<Contact>));
        ...
        public static class Cloning
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (Contact)systemUnderTest.Clone();
            ...
            {
                var propertyNames = new string[] { "Email", "Vid", "Properties" };
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (Contact)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });
        ...
        public static class Serialization
        {
            ...
            public static void Deserialize___Should_roundtrip_object___When_serializing_to_and_deserializing_from_string_using_ObcBsonSerializer()
            {
                ...
                // Act
                var actual = serializer.Deserialize<Contact>(serializedBson);
            ...
            public static void Deserialize___Should_roundtrip_object___When_serializing_to_and_deserializing_from_string_using_ObcJsonSerializer()
            {
                ...
                // Act
                var actual = serializer.Deserialize<Contact>(serializedJson);
        ...
        public static class Equality
        {
            ...
            {
                // Arrange
                Contact systemUnderTest1 = null;
                Contact systemUnderTest2 = null;
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_Contact___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_Contact___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_Contact___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_Contact___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_Contact___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
