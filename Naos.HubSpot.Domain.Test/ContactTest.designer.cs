    ...
    public static partial class ContactTest
    {
                ...
                new StringRepresentationTestScenario<Contact>
                {
                    ...
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        ...
                        var result = new SystemUnderTestExpectedStringRepresentation<Contact>
                        {
                            ...
                            ExpectedStringRepresentation = Invariant($"Naos.HubSpot.Domain.Contact: Properties = {systemUnderTest.Properties?.ToString() ?? "<null>"}."),
                        };
        ...
        public static class Structural
        {
            ...
            public static void ContactV3___Should_implement_IModel_of_ContactV3___When_reflecting()
            {
                ...
                var expectedModelMethods = typeof(IModel<Contact>).GetInterfaceDeclaredAndImplementedMethods();
        ...
        public static class Cloning
        {
            ...
            public static void DeepCloneWith___Should_deep_clone_object_and_replace_the_associated_property_with_the_provided_value___When_called()
            {
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    {
                        var propertyInfo = typeof(Contact).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
