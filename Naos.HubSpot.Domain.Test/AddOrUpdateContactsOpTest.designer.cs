...
namespace Naos.HubSpot.Domain.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<AddOrUpdateContactsOp> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<AddOrUpdateContactsOp>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<AddOrUpdateContactsOp>
                {
                    Name = "Default Code Generated Scenario",
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<AddOrUpdateContactsOp>();

                        var result = new SystemUnderTestExpectedStringRepresentation<AddOrUpdateContactsOp>
                        {
                            SystemUnderTest = systemUnderTest,
                            ExpectedStringRepresentation = Invariant($"Naos.HubSpot.Domain.AddOrUpdateContactsOp: ContactsToAddOrUpdate = {systemUnderTest.ContactsToAddOrUpdate?.ToString() ?? "<null>"}."),
                        };
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<AddOrUpdateContactsOp> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<AddOrUpdateContactsOp>()
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<AddOrUpdateContactsOp>
                {
                    Name = "constructor should throw ArgumentNullException when parameter 'contactsToAddOrUpdate' is null scenario",
                    ConstructionFunc = () =>
                    {
                    ...
                    ExpectedExceptionMessageContains = new[] { "contactsToAddOrUpdate" },
                })
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<AddOrUpdateContactsOp>
                {
                    Name = "constructor should throw ArgumentException when parameter 'contactsToAddOrUpdate' is an empty enumerable scenario",
                    ConstructionFunc = () =>
                    {
                        var result = new AddOrUpdateContactsOp(
                                             new List<Contact>());
                    ...
                    ExpectedExceptionMessageContains = new[] { "contactsToAddOrUpdate", "is an empty enumerable" },
                })
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<AddOrUpdateContactsOp>
                {
                    Name = "constructor should throw ArgumentException when parameter 'contactsToAddOrUpdate' contains a null element scenario",
                    ConstructionFunc = () =>
                    {
                        var referenceObject = A.Dummy<AddOrUpdateContactsOp>();

                        var result = new AddOrUpdateContactsOp(
                                             new Contact[0].Concat(referenceObject.ContactsToAddOrUpdate).Concat(new Contact[] { null }).Concat(referenceObject.ContactsToAddOrUpdate).ToList());

                        return result;
                    },
                    ExpectedExceptionType = typeof(ArgumentException),
                    ExpectedExceptionMessageContains = new[] { "contactsToAddOrUpdate", "contains at least one null element" },
                });

        private static readonly ConstructorPropertyAssignmentTestScenarios<AddOrUpdateContactsOp> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<AddOrUpdateContactsOp>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<AddOrUpdateContactsOp>
                {
                    Name = "ContactsToAddOrUpdate should return same 'contactsToAddOrUpdate' parameter passed to constructor when getting",
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        var referenceObject = A.Dummy<AddOrUpdateContactsOp>();

                        var result = new SystemUnderTestExpectedPropertyValue<AddOrUpdateContactsOp>
                        {
                            SystemUnderTest = new AddOrUpdateContactsOp(
                                                      referenceObject.ContactsToAddOrUpdate),
                            ExpectedPropertyValue = referenceObject.ContactsToAddOrUpdate,
                        };

                        return result;
                    },
                    PropertyName = "ContactsToAddOrUpdate",
                });

        private static readonly DeepCloneWithTestScenarios<AddOrUpdateContactsOp> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<AddOrUpdateContactsOp>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<AddOrUpdateContactsOp>
                {
                    Name = "DeepCloneWithContactsToAddOrUpdate should deep clone object and replace ContactsToAddOrUpdate with the provided contactsToAddOrUpdate",
                    WithPropertyName = "ContactsToAddOrUpdate",
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<AddOrUpdateContactsOp>();

                        var referenceObject = A.Dummy<AddOrUpdateContactsOp>().ThatIs(_ => !systemUnderTest.ContactsToAddOrUpdate.IsEqualTo(_.ContactsToAddOrUpdate));

                        var result = new SystemUnderTestDeepCloneWithValue<AddOrUpdateContactsOp>
                        {
                            SystemUnderTest = systemUnderTest,
                            DeepCloneWithValue = referenceObject.ContactsToAddOrUpdate,
                        };
        ...
        private static readonly AddOrUpdateContactsOp ReferenceObjectForEquatableTestScenarios = A.Dummy<AddOrUpdateContactsOp>();

        private static readonly EquatableTestScenarios<AddOrUpdateContactsOp> EquatableTestScenarios = new EquatableTestScenarios<AddOrUpdateContactsOp>()
            .AddScenario(() =>
                new EquatableTestScenario<AddOrUpdateContactsOp>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new AddOrUpdateContactsOp[]
                    {
                        new AddOrUpdateContactsOp(
                                ReferenceObjectForEquatableTestScenarios.ContactsToAddOrUpdate),
                    },
                    ObjectsThatAreNotEqualToReferenceObject = new AddOrUpdateContactsOp[]
                    {
                        new AddOrUpdateContactsOp(
                                A.Dummy<AddOrUpdateContactsOp>().Whose(_ => !_.ContactsToAddOrUpdate.IsEqualTo(ReferenceObjectForEquatableTestScenarios.ContactsToAddOrUpdate)).ContactsToAddOrUpdate),
                    },
        ...
        public static class Structural
        {
            ...
            public static void AddOrUpdateContactsOp___Should_implement_IModel_of_AddOrUpdateContactsOp___When_reflecting()
            {
                // Arrange
                var type = typeof(AddOrUpdateContactsOp);

                var expectedModelMethods = typeof(IModel<AddOrUpdateContactsOp>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<AddOrUpdateContactsOp>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void AddOrUpdateContactsOp___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(AddOrUpdateContactsOp);
        ...
        public static class Cloning
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (AddOrUpdateContactsOp)systemUnderTest.Clone();
            ...
            public static void DeepClone___Should_deep_clone_object___When_called()
            {
                ...
                if (systemUnderTest.ContactsToAddOrUpdate == null)
                {
                    actual.ContactsToAddOrUpdate.AsTest().Must().BeNull();
                }
                else
                {
                    actual.ContactsToAddOrUpdate.AsTest().Must().NotBeSameReferenceAs(systemUnderTest.ContactsToAddOrUpdate);
                }
            }
            ...
            {
                var propertyNames = new string[] { "ContactsToAddOrUpdate" };
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (AddOrUpdateContactsOp)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach(var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(AddOrUpdateContactsOp).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class Serialization
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<AddOrUpdateContactsOp>();
        ...
        public static class Equality
        {
            ...
            {
                // Arrange
                AddOrUpdateContactsOp systemUnderTest1 = null;
                AddOrUpdateContactsOp systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    AddOrUpdateContactsOp systemUnderTest = null;
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_AddOrUpdateContactsOp___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_AddOrUpdateContactsOp___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_AddOrUpdateContactsOp___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_AddOrUpdateContactsOp___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_AddOrUpdateContactsOp___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
