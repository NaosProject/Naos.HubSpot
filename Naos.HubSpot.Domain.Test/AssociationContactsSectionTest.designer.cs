...
namespace Naos.HubSpot.Domain.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<AssociationContactsSection> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<AssociationContactsSection>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<AssociationContactsSection>
                {
                    Name = "Default Code Generated Scenario",
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<AssociationContactsSection>();

                        var result = new SystemUnderTestExpectedStringRepresentation<AssociationContactsSection>
                        {
                            SystemUnderTest = systemUnderTest,
                            ExpectedStringRepresentation = Invariant($"Naos.HubSpot.Domain.AssociationContactsSection: Results = {systemUnderTest.Results?.ToString() ?? "<null>"}."),
                        };
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<AssociationContactsSection> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<AssociationContactsSection>()
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<AssociationContactsSection>
                {
                    Name = "constructor should throw ArgumentNullException when parameter 'results' is null scenario",
                    ConstructionFunc = () =>
                    {
                    ...
                    ExpectedExceptionMessageContains = new[] { "results" },
                });

        private static readonly ConstructorPropertyAssignmentTestScenarios<AssociationContactsSection> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<AssociationContactsSection>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<AssociationContactsSection>
                {
                    Name = "Results should return same 'results' parameter passed to constructor when getting",
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        var referenceObject = A.Dummy<AssociationContactsSection>();

                        var result = new SystemUnderTestExpectedPropertyValue<AssociationContactsSection>
                        {
                            SystemUnderTest = new AssociationContactsSection(
                                                      referenceObject.Results),
                            ExpectedPropertyValue = referenceObject.Results,
                        };
        ...
        private static readonly DeepCloneWithTestScenarios<AssociationContactsSection> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<AssociationContactsSection>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<AssociationContactsSection>
                {
                    Name = "DeepCloneWithResults should deep clone object and replace Results with the provided results",
                    WithPropertyName = "Results",
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<AssociationContactsSection>();

                        var referenceObject = A.Dummy<AssociationContactsSection>().ThatIs(_ => !systemUnderTest.Results.IsEqualTo(_.Results));

                        var result = new SystemUnderTestDeepCloneWithValue<AssociationContactsSection>
                        {
                            SystemUnderTest = systemUnderTest,
                            DeepCloneWithValue = referenceObject.Results,
                        };
        ...
        private static readonly AssociationContactsSection ReferenceObjectForEquatableTestScenarios = A.Dummy<AssociationContactsSection>();

        private static readonly EquatableTestScenarios<AssociationContactsSection> EquatableTestScenarios = new EquatableTestScenarios<AssociationContactsSection>()
            .AddScenario(() =>
                new EquatableTestScenario<AssociationContactsSection>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new AssociationContactsSection[]
                    {
                        new AssociationContactsSection(
                                ReferenceObjectForEquatableTestScenarios.Results),
                    },
                    ObjectsThatAreNotEqualToReferenceObject = new AssociationContactsSection[]
                    {
                        new AssociationContactsSection(
                                A.Dummy<AssociationContactsSection>().Whose(_ => !_.Results.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Results)).Results),
                    },
        ...
        public static class Structural
        {
            ...
            public static void AssociationContactsSection___Should_implement_IModel_of_AssociationContactsSection___When_reflecting()
            {
                // Arrange
                var type = typeof(AssociationContactsSection);

                var expectedModelMethods = typeof(IModel<AssociationContactsSection>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<AssociationContactsSection>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void AssociationContactsSection___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(AssociationContactsSection);
        ...
        public static class Cloning
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (AssociationContactsSection)systemUnderTest.Clone();
            ...
            public static void DeepClone___Should_deep_clone_object___When_called()
            {
                ...
                if (systemUnderTest.Results == null)
                {
                    actual.Results.AsTest().Must().BeNull();
                }
                else
                {
                    actual.Results.AsTest().Must().NotBeSameReferenceAs(systemUnderTest.Results);
                }
            }
            ...
            {
                var propertyNames = new string[] { "Results" };
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (AssociationContactsSection)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach(var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(AssociationContactsSection).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class Serialization
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<AssociationContactsSection>();
        ...
        public static class Equality
        {
            ...
            {
                // Arrange
                AssociationContactsSection systemUnderTest1 = null;
                AssociationContactsSection systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    AssociationContactsSection systemUnderTest = null;
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_AssociationContactsSection___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_AssociationContactsSection___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_AssociationContactsSection___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_AssociationContactsSection___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_AssociationContactsSection___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
