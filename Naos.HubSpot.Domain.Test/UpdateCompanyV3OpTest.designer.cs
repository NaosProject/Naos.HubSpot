...
namespace Naos.HubSpot.Domain.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<UpdateCompanyV3Op> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<UpdateCompanyV3Op>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<UpdateCompanyV3Op>
                {
                    Name = "Default Code Generated Scenario",
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<UpdateCompanyV3Op>();

                        var result = new SystemUnderTestExpectedStringRepresentation<UpdateCompanyV3Op>
                        {
                            SystemUnderTest = systemUnderTest,
                            ExpectedStringRepresentation = Invariant($"Naos.HubSpot.Domain.UpdateCompanyV3Op: CompanyToUpdate = {systemUnderTest.CompanyToUpdate?.ToString() ?? "<null>"}."),
                        };
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<UpdateCompanyV3Op> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<UpdateCompanyV3Op>()
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<UpdateCompanyV3Op>
                {
                    Name = "constructor should throw ArgumentNullException when parameter 'companyToUpdate' is null scenario",
                    ConstructionFunc = () =>
                    {
                    ...
                    ExpectedExceptionMessageContains = new[] { "companyToUpdate" },
                });

        private static readonly ConstructorPropertyAssignmentTestScenarios<UpdateCompanyV3Op> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<UpdateCompanyV3Op>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<UpdateCompanyV3Op>
                {
                    Name = "CompanyToUpdate should return same 'companyToUpdate' parameter passed to constructor when getting",
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        var referenceObject = A.Dummy<UpdateCompanyV3Op>();

                        var result = new SystemUnderTestExpectedPropertyValue<UpdateCompanyV3Op>
                        {
                            SystemUnderTest = new UpdateCompanyV3Op(
                                                      referenceObject.CompanyToUpdate),
                            ExpectedPropertyValue = referenceObject.CompanyToUpdate,
                        };

                        return result;
                    },
                    PropertyName = "CompanyToUpdate",
                });

        private static readonly DeepCloneWithTestScenarios<UpdateCompanyV3Op> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<UpdateCompanyV3Op>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<UpdateCompanyV3Op>
                {
                    Name = "DeepCloneWithCompanyToUpdate should deep clone object and replace CompanyToUpdate with the provided companyToUpdate",
                    WithPropertyName = "CompanyToUpdate",
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<UpdateCompanyV3Op>();

                        var referenceObject = A.Dummy<UpdateCompanyV3Op>().ThatIs(_ => !systemUnderTest.CompanyToUpdate.IsEqualTo(_.CompanyToUpdate));

                        var result = new SystemUnderTestDeepCloneWithValue<UpdateCompanyV3Op>
                        {
                            SystemUnderTest = systemUnderTest,
                            DeepCloneWithValue = referenceObject.CompanyToUpdate,
                        };
        ...
        private static readonly UpdateCompanyV3Op ReferenceObjectForEquatableTestScenarios = A.Dummy<UpdateCompanyV3Op>();

        private static readonly EquatableTestScenarios<UpdateCompanyV3Op> EquatableTestScenarios = new EquatableTestScenarios<UpdateCompanyV3Op>()
            .AddScenario(() =>
                new EquatableTestScenario<UpdateCompanyV3Op>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new UpdateCompanyV3Op[]
                    {
                        new UpdateCompanyV3Op(
                                ReferenceObjectForEquatableTestScenarios.CompanyToUpdate),
                    },
                    ObjectsThatAreNotEqualToReferenceObject = new UpdateCompanyV3Op[]
                    {
                        new UpdateCompanyV3Op(
                                A.Dummy<UpdateCompanyV3Op>().Whose(_ => !_.CompanyToUpdate.IsEqualTo(ReferenceObjectForEquatableTestScenarios.CompanyToUpdate)).CompanyToUpdate),
                    },
        ...
        public static class Structural
        {
            ...
            public static void UpdateCompanyV3Op___Should_implement_IModel_of_UpdateCompanyV3Op___When_reflecting()
            {
                // Arrange
                var type = typeof(UpdateCompanyV3Op);

                var expectedModelMethods = typeof(IModel<UpdateCompanyV3Op>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<UpdateCompanyV3Op>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void UpdateCompanyV3Op___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(UpdateCompanyV3Op);
        ...
        public static class Cloning
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (UpdateCompanyV3Op)systemUnderTest.Clone();
            ...
            public static void DeepClone___Should_deep_clone_object___When_called()
            {
                ...
                if (systemUnderTest.CompanyToUpdate == null)
                {
                    actual.CompanyToUpdate.AsTest().Must().BeNull();
                }
                else
                {
                    actual.CompanyToUpdate.AsTest().Must().NotBeSameReferenceAs(systemUnderTest.CompanyToUpdate);
                }
            }
            ...
            {
                var propertyNames = new string[] { "CompanyToUpdate" };
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (UpdateCompanyV3Op)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach(var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(UpdateCompanyV3Op).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class Serialization
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<UpdateCompanyV3Op>();
        ...
        public static class Equality
        {
            ...
            {
                // Arrange
                UpdateCompanyV3Op systemUnderTest1 = null;
                UpdateCompanyV3Op systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    UpdateCompanyV3Op systemUnderTest = null;
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_UpdateCompanyV3Op___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_UpdateCompanyV3Op___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_UpdateCompanyV3Op___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_UpdateCompanyV3Op___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_UpdateCompanyV3Op___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
