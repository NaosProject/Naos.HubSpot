...
namespace Naos.HubSpot.Domain.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<AddOrUpdateContactsRequest> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<AddOrUpdateContactsRequest>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<AddOrUpdateContactsRequest>
                {
                    Name = "Default Code Generated Scenario",
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<AddOrUpdateContactsRequest>();

                        var result = new SystemUnderTestExpectedStringRepresentation<AddOrUpdateContactsRequest>
                        {
                            SystemUnderTest = systemUnderTest,
                            ExpectedStringRepresentation = Invariant($"Naos.HubSpot.Domain.AddOrUpdateContactsRequest: Vid = {systemUnderTest.Vid?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}, Email = {systemUnderTest.Email?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}, Properties = {systemUnderTest.Properties?.ToString() ?? "<null>"}."),
                        };
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<AddOrUpdateContactsRequest> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<AddOrUpdateContactsRequest>()
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<AddOrUpdateContactsRequest>
                {
                    Name = "constructor should throw ArgumentNullException when parameter 'email' is null scenario",
                    ConstructionFunc = () =>
                    {
                        var referenceObject = A.Dummy<AddOrUpdateContactsRequest>();

                        var result = new AddOrUpdateContactsRequest(
                                             referenceObject.Vid,
                                             null,
            ...
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<AddOrUpdateContactsRequest>
                {
                    Name = "constructor should throw ArgumentException when parameter 'properties' is an empty enumerable scenario",
                    ConstructionFunc = () =>
                    {
                        var referenceObject = A.Dummy<AddOrUpdateContactsRequest>();
                    ...
                    ExpectedExceptionType = typeof(ArgumentException),
                    ExpectedExceptionMessageContains = new[] { "properties", "is an empty enumerable" },
                })
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<AddOrUpdateContactsRequest>
                {
                    Name = "constructor should throw ArgumentException when parameter 'properties' contains a null element scenario",
                    ConstructionFunc = () =>
                    {
                        var referenceObject = A.Dummy<AddOrUpdateContactsRequest>();
                        ...
                        var result = new AddOrUpdateContactsRequest(
                                             referenceObject.Vid,
                                             referenceObject.Email,
                                             new PropertyModel[0].Concat(referenceObject.Properties).Concat(new PropertyModel[] { null }).Concat(referenceObject.Properties).ToList());

                        return result;
                    },
                    ExpectedExceptionType = typeof(ArgumentException),
                    ExpectedExceptionMessageContains = new[] { "properties", "contains at least one null element" },
                });

        private static readonly ConstructorPropertyAssignmentTestScenarios<AddOrUpdateContactsRequest> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<AddOrUpdateContactsRequest>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<AddOrUpdateContactsRequest>
                {
                    Name = "Vid should return same 'vid' parameter passed to constructor when getting",
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        var referenceObject = A.Dummy<AddOrUpdateContactsRequest>();

                        var result = new SystemUnderTestExpectedPropertyValue<AddOrUpdateContactsRequest>
                        {
                            SystemUnderTest = new AddOrUpdateContactsRequest(
                                                      referenceObject.Vid,
                                                      referenceObject.Email,
                                                      referenceObject.Properties),
            ...
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<AddOrUpdateContactsRequest>
                {
                    Name = "Email should return same 'email' parameter passed to constructor when getting",
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        var referenceObject = A.Dummy<AddOrUpdateContactsRequest>();
        ...
        private static readonly DeepCloneWithTestScenarios<AddOrUpdateContactsRequest> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<AddOrUpdateContactsRequest>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<AddOrUpdateContactsRequest>
                {
                    Name = "DeepCloneWithVid should deep clone object and replace Vid with the provided vid",
                    WithPropertyName = "Vid",
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<AddOrUpdateContactsRequest>();

                        var referenceObject = A.Dummy<AddOrUpdateContactsRequest>().ThatIs(_ => !systemUnderTest.Vid.IsEqualTo(_.Vid));

                        var result = new SystemUnderTestDeepCloneWithValue<AddOrUpdateContactsRequest>
                        {
                            SystemUnderTest = systemUnderTest,
                            DeepCloneWithValue = referenceObject.Vid,
                        };
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<AddOrUpdateContactsRequest>
                {
                    Name = "DeepCloneWithEmail should deep clone object and replace Email with the provided email",
                    WithPropertyName = "Email",
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<AddOrUpdateContactsRequest>();

                        var referenceObject = A.Dummy<AddOrUpdateContactsRequest>().ThatIs(_ => !systemUnderTest.Email.IsEqualTo(_.Email));

                        var result = new SystemUnderTestDeepCloneWithValue<AddOrUpdateContactsRequest>
                        {
                            SystemUnderTest = systemUnderTest,
                            DeepCloneWithValue = referenceObject.Email,
                        };
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<AddOrUpdateContactsRequest>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<AddOrUpdateContactsRequest>().ThatIs(_ => !systemUnderTest.Properties.IsEqualTo(_.Properties));
        ...
        private static readonly AddOrUpdateContactsRequest ReferenceObjectForEquatableTestScenarios = A.Dummy<AddOrUpdateContactsRequest>();

        private static readonly EquatableTestScenarios<AddOrUpdateContactsRequest> EquatableTestScenarios = new EquatableTestScenarios<AddOrUpdateContactsRequest>()
            .AddScenario(() =>
                new EquatableTestScenario<AddOrUpdateContactsRequest>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new AddOrUpdateContactsRequest[]
                    {
                    ...
                    ObjectsThatAreNotEqualToReferenceObject = new AddOrUpdateContactsRequest[]
                    {
                        new AddOrUpdateContactsRequest(
                                A.Dummy<AddOrUpdateContactsRequest>().Whose(_ => !_.Vid.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Vid)).Vid,
                                ReferenceObjectForEquatableTestScenarios.Email,
                                ReferenceObjectForEquatableTestScenarios.Properties),
                        new AddOrUpdateContactsRequest(
                                ReferenceObjectForEquatableTestScenarios.Vid,
                                A.Dummy<AddOrUpdateContactsRequest>().Whose(_ => !_.Email.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Email)).Email,
                                ReferenceObjectForEquatableTestScenarios.Properties),
                        new AddOrUpdateContactsRequest(
                                ReferenceObjectForEquatableTestScenarios.Vid,
                                ReferenceObjectForEquatableTestScenarios.Email,
                                A.Dummy<AddOrUpdateContactsRequest>().Whose(_ => !_.Properties.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Properties)).Properties),
                    },
        ...
        public static class Structural
        {
            ...
            public static void AddOrUpdateContactsRequest___Should_implement_IModel_of_AddOrUpdateContactsRequest___When_reflecting()
            {
                // Arrange
                var type = typeof(AddOrUpdateContactsRequest);

                var expectedModelMethods = typeof(IModel<AddOrUpdateContactsRequest>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<AddOrUpdateContactsRequest>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void AddOrUpdateContactsRequest___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(AddOrUpdateContactsRequest);
        ...
        public static class Cloning
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (AddOrUpdateContactsRequest)systemUnderTest.Clone();
            ...
            {
                var propertyNames = new string[] { "Vid", "Email", "Properties" };
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (AddOrUpdateContactsRequest)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach(var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(AddOrUpdateContactsRequest).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class Serialization
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<AddOrUpdateContactsRequest>();
        ...
        public static class Equality
        {
            ...
            {
                // Arrange
                AddOrUpdateContactsRequest systemUnderTest1 = null;
                AddOrUpdateContactsRequest systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    AddOrUpdateContactsRequest systemUnderTest = null;
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_AddOrUpdateContactsRequest___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_AddOrUpdateContactsRequest___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_AddOrUpdateContactsRequest___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_AddOrUpdateContactsRequest___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_AddOrUpdateContactsRequest___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
