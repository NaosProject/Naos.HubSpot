...
namespace Naos.HubSpot.Domain.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<UpdateContactV3Op> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<UpdateContactV3Op>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<UpdateContactV3Op>
                {
                    Name = "Default Code Generated Scenario",
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<UpdateContactV3Op>();

                        var result = new SystemUnderTestExpectedStringRepresentation<UpdateContactV3Op>
                        {
                            SystemUnderTest = systemUnderTest,
                            ExpectedStringRepresentation = Invariant($"Naos.HubSpot.Domain.UpdateContactV3Op: ContactToUpdate = {systemUnderTest.ContactToUpdate?.ToString() ?? "<null>"}."),
                        };
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<UpdateContactV3Op> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<UpdateContactV3Op>()
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<UpdateContactV3Op>
                {
                    Name = "constructor should throw ArgumentNullException when parameter 'contactToUpdate' is null scenario",
                    ConstructionFunc = () =>
                    {
                    ...
                    ExpectedExceptionMessageContains = new[] { "contactToUpdate" },
                });

        private static readonly ConstructorPropertyAssignmentTestScenarios<UpdateContactV3Op> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<UpdateContactV3Op>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<UpdateContactV3Op>
                {
                    Name = "ContactToUpdate should return same 'contactToUpdate' parameter passed to constructor when getting",
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        var referenceObject = A.Dummy<UpdateContactV3Op>();

                        var result = new SystemUnderTestExpectedPropertyValue<UpdateContactV3Op>
                        {
                            SystemUnderTest = new UpdateContactV3Op(
                                                      referenceObject.ContactToUpdate),
                            ExpectedPropertyValue = referenceObject.ContactToUpdate,
                        };

                        return result;
                    },
                    PropertyName = "ContactToUpdate",
                });

        private static readonly DeepCloneWithTestScenarios<UpdateContactV3Op> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<UpdateContactV3Op>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<UpdateContactV3Op>
                {
                    Name = "DeepCloneWithContactToUpdate should deep clone object and replace ContactToUpdate with the provided contactToUpdate",
                    WithPropertyName = "ContactToUpdate",
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<UpdateContactV3Op>();

                        var referenceObject = A.Dummy<UpdateContactV3Op>().ThatIs(_ => !systemUnderTest.ContactToUpdate.IsEqualTo(_.ContactToUpdate));

                        var result = new SystemUnderTestDeepCloneWithValue<UpdateContactV3Op>
                        {
                            SystemUnderTest = systemUnderTest,
                            DeepCloneWithValue = referenceObject.ContactToUpdate,
                        };
        ...
        private static readonly UpdateContactV3Op ReferenceObjectForEquatableTestScenarios = A.Dummy<UpdateContactV3Op>();

        private static readonly EquatableTestScenarios<UpdateContactV3Op> EquatableTestScenarios = new EquatableTestScenarios<UpdateContactV3Op>()
            .AddScenario(() =>
                new EquatableTestScenario<UpdateContactV3Op>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new UpdateContactV3Op[]
                    {
                        new UpdateContactV3Op(
                                ReferenceObjectForEquatableTestScenarios.ContactToUpdate),
                    },
                    ObjectsThatAreNotEqualToReferenceObject = new UpdateContactV3Op[]
                    {
                        new UpdateContactV3Op(
                                A.Dummy<UpdateContactV3Op>().Whose(_ => !_.ContactToUpdate.IsEqualTo(ReferenceObjectForEquatableTestScenarios.ContactToUpdate)).ContactToUpdate),
                    },
        ...
        public static class Structural
        {
            ...
            public static void UpdateContactV3Op___Should_implement_IModel_of_UpdateContactV3Op___When_reflecting()
            {
                // Arrange
                var type = typeof(UpdateContactV3Op);

                var expectedModelMethods = typeof(IModel<UpdateContactV3Op>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<UpdateContactV3Op>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void UpdateContactV3Op___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(UpdateContactV3Op);
        ...
        public static class Cloning
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (UpdateContactV3Op)systemUnderTest.Clone();
            ...
            public static void DeepClone___Should_deep_clone_object___When_called()
            {
                ...
                if (systemUnderTest.ContactToUpdate == null)
                {
                    actual.ContactToUpdate.AsTest().Must().BeNull();
                }
                else
                {
                    actual.ContactToUpdate.AsTest().Must().NotBeSameReferenceAs(systemUnderTest.ContactToUpdate);
                }
            }
            ...
            {
                var propertyNames = new string[] { "ContactToUpdate" };
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (UpdateContactV3Op)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach(var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(UpdateContactV3Op).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class Serialization
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<UpdateContactV3Op>();
        ...
        public static class Equality
        {
            ...
            {
                // Arrange
                UpdateContactV3Op systemUnderTest1 = null;
                UpdateContactV3Op systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    UpdateContactV3Op systemUnderTest = null;
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_UpdateContactV3Op___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_UpdateContactV3Op___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_UpdateContactV3Op___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_UpdateContactV3Op___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_UpdateContactV3Op___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
