...
namespace Naos.HubSpot.Domain.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<ContactRequestModelV3> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<ContactRequestModelV3>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<ContactRequestModelV3>
                {
                    Name = "Default Code Generated Scenario",
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<ContactRequestModelV3>();

                        var result = new SystemUnderTestExpectedStringRepresentation<ContactRequestModelV3>
                        {
                            SystemUnderTest = systemUnderTest,
                            ExpectedStringRepresentation = Invariant($"Naos.HubSpot.Domain.ContactRequestModelV3: Id = {systemUnderTest.Id?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}, Properties = {systemUnderTest.Properties?.ToString() ?? "<null>"}."),
                        };
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<ContactRequestModelV3> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<ContactRequestModelV3>()
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<ContactRequestModelV3>
                {
                    Name = "constructor should throw ArgumentNullException when parameter 'id' is null scenario",
                    ConstructionFunc = () =>
                    {
                        var referenceObject = A.Dummy<ContactRequestModelV3>();

                        var result = new ContactRequestModelV3(
                                             null,
        ...
        private static readonly ConstructorPropertyAssignmentTestScenarios<ContactRequestModelV3> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<ContactRequestModelV3>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<ContactRequestModelV3>
                {
                    ...
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        ...
                        var result = new SystemUnderTestExpectedPropertyValue<ContactRequestModelV3>
                        {
                            SystemUnderTest = new ContactRequestModelV3(
                                                      referenceObject.Id,
                                                      referenceObject.Properties),
        ...
        private static readonly DeepCloneWithTestScenarios<ContactRequestModelV3> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<ContactRequestModelV3>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<ContactRequestModelV3>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<ContactRequestModelV3>().ThatIs(_ => !systemUnderTest.Id.IsEqualTo(_.Id));

                        var result = new SystemUnderTestDeepCloneWithValue<ContactRequestModelV3>
                        {
                            SystemUnderTest = systemUnderTest,
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<ContactRequestModelV3>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<ContactRequestModelV3>().ThatIs(_ => !systemUnderTest.Properties.IsEqualTo(_.Properties));
        ...
        private static readonly ContactRequestModelV3 ReferenceObjectForEquatableTestScenarios = A.Dummy<ContactRequestModelV3>();

        private static readonly EquatableTestScenarios<ContactRequestModelV3> EquatableTestScenarios = new EquatableTestScenarios<ContactRequestModelV3>()
            .AddScenario(() =>
                new EquatableTestScenario<ContactRequestModelV3>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new ContactRequestModelV3[]
                    {
                        new ContactRequestModelV3(
                                ReferenceObjectForEquatableTestScenarios.Id,
                                ReferenceObjectForEquatableTestScenarios.Properties),
                    },
                    ObjectsThatAreNotEqualToReferenceObject = new ContactRequestModelV3[]
                    {
                        new ContactRequestModelV3(
                                A.Dummy<ContactRequestModelV3>().Whose(_ => !_.Id.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Id)).Id,
                                ReferenceObjectForEquatableTestScenarios.Properties),
                        new ContactRequestModelV3(
                                ReferenceObjectForEquatableTestScenarios.Id,
                                A.Dummy<ContactRequestModelV3>().Whose(_ => !_.Properties.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Properties)).Properties),
                    },
        ...
        public static class Structural
        {
            ...
            {
                // Arrange
                var type = typeof(ContactRequestModelV3);

                var expectedModelMethods = typeof(IModel<ContactRequestModelV3>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<ContactRequestModelV3>));
        ...
        public static class Cloning
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (ContactRequestModelV3)systemUnderTest.Clone();
            ...
            public static void DeepCloneWith___Should_deep_clone_object_and_replace_the_associated_property_with_the_provided_value___When_called()
            {
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (ContactRequestModelV3)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach(var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(ContactRequestModelV3).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class Serialization
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<ContactRequestModelV3>();
        ...
        public static class Equality
        {
            ...
            {
                // Arrange
                ContactRequestModelV3 systemUnderTest1 = null;
                ContactRequestModelV3 systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    ContactRequestModelV3 systemUnderTest = null;
