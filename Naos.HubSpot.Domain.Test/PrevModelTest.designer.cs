...
namespace Naos.HubSpot.Domain.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<PrevModel> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<PrevModel>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<PrevModel>
                {
                    Name = "Default Code Generated Scenario",
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<PrevModel>();

                        var result = new SystemUnderTestExpectedStringRepresentation<PrevModel>
                        {
                            SystemUnderTest = systemUnderTest,
                            ExpectedStringRepresentation = Invariant($"Naos.HubSpot.Domain.PrevModel: Before = {systemUnderTest.Before?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}, Link = {systemUnderTest.Link?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}."),
                        };
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<PrevModel> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<PrevModel>()
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<PrevModel>
                {
                    Name = "constructor should throw ArgumentNullException when parameter 'before' is null scenario",
                    ConstructionFunc = () =>
                    {
                        var referenceObject = A.Dummy<PrevModel>();

                        var result = new PrevModel(
                                             null,
                    ...
                    ExpectedExceptionMessageContains = new[] { "before" },
                })
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<PrevModel>
                {
                    Name = "constructor should throw ArgumentException when parameter 'before' is white space scenario",
                    ConstructionFunc = () =>
                    {
                        var referenceObject = A.Dummy<PrevModel>();
                    ...
                    ExpectedExceptionMessageContains = new[] { "before", "white space" },
                })
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<PrevModel>
                {
        ...
        private static readonly ConstructorPropertyAssignmentTestScenarios<PrevModel> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<PrevModel>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<PrevModel>
                {
                    Name = "Before should return same 'before' parameter passed to constructor when getting",
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        var referenceObject = A.Dummy<PrevModel>();

                        var result = new SystemUnderTestExpectedPropertyValue<PrevModel>
                        {
                            SystemUnderTest = new PrevModel(
                                                      referenceObject.Before,
                                                      referenceObject.Link),
                            ExpectedPropertyValue = referenceObject.Before,
                        };
        ...
        private static readonly DeepCloneWithTestScenarios<PrevModel> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<PrevModel>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<PrevModel>
                {
                    Name = "DeepCloneWithBefore should deep clone object and replace Before with the provided before",
                    WithPropertyName = "Before",
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<PrevModel>();

                        var referenceObject = A.Dummy<PrevModel>().ThatIs(_ => !systemUnderTest.Before.IsEqualTo(_.Before));

                        var result = new SystemUnderTestDeepCloneWithValue<PrevModel>
                        {
                            SystemUnderTest = systemUnderTest,
                            DeepCloneWithValue = referenceObject.Before,
                        };
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<PrevModel>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<PrevModel>().ThatIs(_ => !systemUnderTest.Link.IsEqualTo(_.Link));
        ...
        private static readonly PrevModel ReferenceObjectForEquatableTestScenarios = A.Dummy<PrevModel>();

        private static readonly EquatableTestScenarios<PrevModel> EquatableTestScenarios = new EquatableTestScenarios<PrevModel>()
            .AddScenario(() =>
                new EquatableTestScenario<PrevModel>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new PrevModel[]
                    {
                        new PrevModel(
                                ReferenceObjectForEquatableTestScenarios.Before,
                                ReferenceObjectForEquatableTestScenarios.Link),
                    },
                    ObjectsThatAreNotEqualToReferenceObject = new PrevModel[]
                    {
                        new PrevModel(
                                A.Dummy<PrevModel>().Whose(_ => !_.Before.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Before)).Before,
                                ReferenceObjectForEquatableTestScenarios.Link),
                        new PrevModel(
                                ReferenceObjectForEquatableTestScenarios.Before,
                                A.Dummy<PrevModel>().Whose(_ => !_.Link.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Link)).Link),
                    },
        ...
        public static class Structural
        {
            ...
            public static void PrevModel___Should_implement_IModel_of_PrevModel___When_reflecting()
            {
                // Arrange
                var type = typeof(PrevModel);

                var expectedModelMethods = typeof(IModel<PrevModel>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<PrevModel>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void PrevModel___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(PrevModel);
        ...
        public static class Cloning
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (PrevModel)systemUnderTest.Clone();
            ...
            {
                var propertyNames = new string[] { "Before", "Link" };
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (PrevModel)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach(var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(PrevModel).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class Serialization
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<PrevModel>();
        ...
        public static class Equality
        {
            ...
            {
                // Arrange
                PrevModel systemUnderTest1 = null;
                PrevModel systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    PrevModel systemUnderTest = null;
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_PrevModel___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_PrevModel___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_PrevModel___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_PrevModel___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_PrevModel___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
