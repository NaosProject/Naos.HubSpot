...
namespace Naos.HubSpot.Domain.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<CompanyRequestModelV3> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<CompanyRequestModelV3>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<CompanyRequestModelV3>
                {
                    Name = "Default Code Generated Scenario",
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<CompanyRequestModelV3>();

                        var result = new SystemUnderTestExpectedStringRepresentation<CompanyRequestModelV3>
                        {
                            SystemUnderTest = systemUnderTest,
                            ExpectedStringRepresentation = Invariant($"Naos.HubSpot.Domain.CompanyRequestModelV3: Id = {systemUnderTest.Id?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}, Properties = {systemUnderTest.Properties?.ToString() ?? "<null>"}."),
                        };
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<CompanyRequestModelV3> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<CompanyRequestModelV3>()
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<CompanyRequestModelV3>
                {
                    Name = "constructor should throw ArgumentNullException when parameter 'id' is null scenario",
                    ConstructionFunc = () =>
                    {
                        var referenceObject = A.Dummy<CompanyRequestModelV3>();

                        var result = new CompanyRequestModelV3(
                                             null,
        ...
        private static readonly ConstructorPropertyAssignmentTestScenarios<CompanyRequestModelV3> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<CompanyRequestModelV3>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<CompanyRequestModelV3>
                {
                    ...
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        ...
                        var result = new SystemUnderTestExpectedPropertyValue<CompanyRequestModelV3>
                        {
                            SystemUnderTest = new CompanyRequestModelV3(
                                                      referenceObject.Id,
                                                      referenceObject.Properties),
        ...
        private static readonly DeepCloneWithTestScenarios<CompanyRequestModelV3> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<CompanyRequestModelV3>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<CompanyRequestModelV3>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<CompanyRequestModelV3>().ThatIs(_ => !systemUnderTest.Id.IsEqualTo(_.Id));

                        var result = new SystemUnderTestDeepCloneWithValue<CompanyRequestModelV3>
                        {
                            SystemUnderTest = systemUnderTest,
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<CompanyRequestModelV3>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<CompanyRequestModelV3>().ThatIs(_ => !systemUnderTest.Properties.IsEqualTo(_.Properties));
        ...
        private static readonly CompanyRequestModelV3 ReferenceObjectForEquatableTestScenarios = A.Dummy<CompanyRequestModelV3>();

        private static readonly EquatableTestScenarios<CompanyRequestModelV3> EquatableTestScenarios = new EquatableTestScenarios<CompanyRequestModelV3>()
            .AddScenario(() =>
                new EquatableTestScenario<CompanyRequestModelV3>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new CompanyRequestModelV3[]
                    {
                        new CompanyRequestModelV3(
                                ReferenceObjectForEquatableTestScenarios.Id,
                                ReferenceObjectForEquatableTestScenarios.Properties),
                    },
                    ObjectsThatAreNotEqualToReferenceObject = new CompanyRequestModelV3[]
                    {
                        new CompanyRequestModelV3(
                                A.Dummy<CompanyRequestModelV3>().Whose(_ => !_.Id.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Id)).Id,
                                ReferenceObjectForEquatableTestScenarios.Properties),
                        new CompanyRequestModelV3(
                                ReferenceObjectForEquatableTestScenarios.Id,
                                A.Dummy<CompanyRequestModelV3>().Whose(_ => !_.Properties.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Properties)).Properties),
                    },
        ...
        public static class Structural
        {
            ...
            public static void CompanyRequestModelV3___Should_implement_IModel_of_CompanyRequestModelV3___When_reflecting()
            {
                // Arrange
                var type = typeof(CompanyRequestModelV3);

                var expectedModelMethods = typeof(IModel<CompanyRequestModelV3>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<CompanyRequestModelV3>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void CompanyRequestModelV3___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(CompanyRequestModelV3);
        ...
        public static class Cloning
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (CompanyRequestModelV3)systemUnderTest.Clone();
            ...
            {
                var propertyNames = new string[] { "Id", "Properties" };
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (CompanyRequestModelV3)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach(var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(CompanyRequestModelV3).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class Serialization
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<CompanyRequestModelV3>();
        ...
        public static class Equality
        {
            ...
            {
                // Arrange
                CompanyRequestModelV3 systemUnderTest1 = null;
                CompanyRequestModelV3 systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    CompanyRequestModelV3 systemUnderTest = null;
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_CompanyRequestModelV3___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_CompanyRequestModelV3___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_CompanyRequestModelV3___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_CompanyRequestModelV3___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_CompanyRequestModelV3___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
