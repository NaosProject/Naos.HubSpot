...
namespace Naos.HubSpot.Domain.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<RemoveContactByHubSpotIdV3Op> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<RemoveContactByHubSpotIdV3Op>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<RemoveContactByHubSpotIdV3Op>
                {
                    Name = "Default Code Generated Scenario",
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<RemoveContactByHubSpotIdV3Op>();

                        var result = new SystemUnderTestExpectedStringRepresentation<RemoveContactByHubSpotIdV3Op>
                        {
                            SystemUnderTest = systemUnderTest,
                            ExpectedStringRepresentation = Invariant($"Naos.HubSpot.Domain.RemoveContactByHubSpotIdV3Op: HubSpotId = {systemUnderTest.HubSpotId?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}."),
                        };
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<RemoveContactByHubSpotIdV3Op> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<RemoveContactByHubSpotIdV3Op>()
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<RemoveContactByHubSpotIdV3Op>
                {
                    Name = "constructor should throw ArgumentNullException when parameter 'hubSpotId' is null scenario",
                    ConstructionFunc = () =>
                    {
                        var result = new RemoveContactByHubSpotIdV3Op(
                                             null);
        ...
        private static readonly ConstructorPropertyAssignmentTestScenarios<RemoveContactByHubSpotIdV3Op> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<RemoveContactByHubSpotIdV3Op>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<RemoveContactByHubSpotIdV3Op>
                {
                    Name = "HubSpotId should return same 'hubSpotId' parameter passed to constructor when getting",
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        var referenceObject = A.Dummy<RemoveContactByHubSpotIdV3Op>();

                        var result = new SystemUnderTestExpectedPropertyValue<RemoveContactByHubSpotIdV3Op>
                        {
                            SystemUnderTest = new RemoveContactByHubSpotIdV3Op(
        ...
        private static readonly DeepCloneWithTestScenarios<RemoveContactByHubSpotIdV3Op> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<RemoveContactByHubSpotIdV3Op>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<RemoveContactByHubSpotIdV3Op>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<RemoveContactByHubSpotIdV3Op>().ThatIs(_ => !systemUnderTest.HubSpotId.IsEqualTo(_.HubSpotId));

                        var result = new SystemUnderTestDeepCloneWithValue<RemoveContactByHubSpotIdV3Op>
                        {
                            SystemUnderTest = systemUnderTest,
        ...
        private static readonly RemoveContactByHubSpotIdV3Op ReferenceObjectForEquatableTestScenarios = A.Dummy<RemoveContactByHubSpotIdV3Op>();

        private static readonly EquatableTestScenarios<RemoveContactByHubSpotIdV3Op> EquatableTestScenarios = new EquatableTestScenarios<RemoveContactByHubSpotIdV3Op>()
            .AddScenario(() =>
                new EquatableTestScenario<RemoveContactByHubSpotIdV3Op>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new RemoveContactByHubSpotIdV3Op[]
                    {
                        new RemoveContactByHubSpotIdV3Op(
                                ReferenceObjectForEquatableTestScenarios.HubSpotId),
                    },
                    ObjectsThatAreNotEqualToReferenceObject = new RemoveContactByHubSpotIdV3Op[]
                    {
                        new RemoveContactByHubSpotIdV3Op(
                                A.Dummy<RemoveContactByHubSpotIdV3Op>().Whose(_ => !_.HubSpotId.IsEqualTo(ReferenceObjectForEquatableTestScenarios.HubSpotId)).HubSpotId),
                    },
        ...
        public static class Structural
        {
            ...
            public static void RemoveContactByHubSpotIdV3Op___Should_implement_IModel_of_RemoveContactByHubSpotIdV3Op___When_reflecting()
            {
                // Arrange
                var type = typeof(RemoveContactByHubSpotIdV3Op);

                var expectedModelMethods = typeof(IModel<RemoveContactByHubSpotIdV3Op>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<RemoveContactByHubSpotIdV3Op>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void RemoveContactByHubSpotIdV3Op___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(RemoveContactByHubSpotIdV3Op);
        ...
        public static class Cloning
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (RemoveContactByHubSpotIdV3Op)systemUnderTest.Clone();
            ...
            public static void DeepCloneWith___Should_deep_clone_object_and_replace_the_associated_property_with_the_provided_value___When_called()
            {
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (RemoveContactByHubSpotIdV3Op)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach(var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(RemoveContactByHubSpotIdV3Op).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class Serialization
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<RemoveContactByHubSpotIdV3Op>();
        ...
        public static class Equality
        {
            ...
            {
                // Arrange
                RemoveContactByHubSpotIdV3Op systemUnderTest1 = null;
                RemoveContactByHubSpotIdV3Op systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    RemoveContactByHubSpotIdV3Op systemUnderTest = null;
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_RemoveContactByHubSpotIdV3Op___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_RemoveContactByHubSpotIdV3Op___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_RemoveContactByHubSpotIdV3Op___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_RemoveContactByHubSpotIdV3Op___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_RemoveContactByHubSpotIdV3Op___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
