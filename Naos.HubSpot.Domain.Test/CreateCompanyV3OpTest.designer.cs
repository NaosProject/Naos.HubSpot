...
namespace Naos.HubSpot.Domain.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<CreateCompanyV3Op> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<CreateCompanyV3Op>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<CreateCompanyV3Op>
                {
                    Name = "Default Code Generated Scenario",
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<CreateCompanyV3Op>();

                        var result = new SystemUnderTestExpectedStringRepresentation<CreateCompanyV3Op>
                        {
                            SystemUnderTest = systemUnderTest,
                            ExpectedStringRepresentation = Invariant($"Naos.HubSpot.Domain.CreateCompanyV3Op: CompanyToCreate = {systemUnderTest.CompanyToCreate?.ToString() ?? "<null>"}."),
                        };
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<CreateCompanyV3Op> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<CreateCompanyV3Op>()
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<CreateCompanyV3Op>
                {
                    Name = "constructor should throw ArgumentNullException when parameter 'companyToCreate' is null scenario",
                    ConstructionFunc = () =>
                    {
                        var result = new CreateCompanyV3Op(
                                             null);

                        return result;
                    },
                    ExpectedExceptionType = typeof(ArgumentNullException),
                    ExpectedExceptionMessageContains = new[] { "companyToCreate" },
                });

        private static readonly ConstructorPropertyAssignmentTestScenarios<CreateCompanyV3Op> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<CreateCompanyV3Op>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<CreateCompanyV3Op>
                {
                    Name = "CompanyToCreate should return same 'companyToCreate' parameter passed to constructor when getting",
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        var referenceObject = A.Dummy<CreateCompanyV3Op>();

                        var result = new SystemUnderTestExpectedPropertyValue<CreateCompanyV3Op>
                        {
                            SystemUnderTest = new CreateCompanyV3Op(
                                                      referenceObject.CompanyToCreate),
                            ExpectedPropertyValue = referenceObject.CompanyToCreate,
                        };

                        return result;
                    },
                    PropertyName = "CompanyToCreate",
                });

        private static readonly DeepCloneWithTestScenarios<CreateCompanyV3Op> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<CreateCompanyV3Op>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<CreateCompanyV3Op>
                {
                    Name = "DeepCloneWithCompanyToCreate should deep clone object and replace CompanyToCreate with the provided companyToCreate",
                    WithPropertyName = "CompanyToCreate",
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<CreateCompanyV3Op>();

                        var referenceObject = A.Dummy<CreateCompanyV3Op>().ThatIs(_ => !systemUnderTest.CompanyToCreate.IsEqualTo(_.CompanyToCreate));

                        var result = new SystemUnderTestDeepCloneWithValue<CreateCompanyV3Op>
                        {
                            SystemUnderTest = systemUnderTest,
                            DeepCloneWithValue = referenceObject.CompanyToCreate,
                        };
        ...
        private static readonly CreateCompanyV3Op ReferenceObjectForEquatableTestScenarios = A.Dummy<CreateCompanyV3Op>();

        private static readonly EquatableTestScenarios<CreateCompanyV3Op> EquatableTestScenarios = new EquatableTestScenarios<CreateCompanyV3Op>()
            .AddScenario(() =>
                new EquatableTestScenario<CreateCompanyV3Op>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new CreateCompanyV3Op[]
                    {
                        new CreateCompanyV3Op(
                                ReferenceObjectForEquatableTestScenarios.CompanyToCreate),
                    },
                    ObjectsThatAreNotEqualToReferenceObject = new CreateCompanyV3Op[]
                    {
                        new CreateCompanyV3Op(
                                A.Dummy<CreateCompanyV3Op>().Whose(_ => !_.CompanyToCreate.IsEqualTo(ReferenceObjectForEquatableTestScenarios.CompanyToCreate)).CompanyToCreate),
                    },
        ...
        public static class Structural
        {
            ...
            public static void CreateCompanyV3Op___Should_implement_IModel_of_CreateCompanyV3Op___When_reflecting()
            {
                // Arrange
                var type = typeof(CreateCompanyV3Op);

                var expectedModelMethods = typeof(IModel<CreateCompanyV3Op>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<CreateCompanyV3Op>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void CreateCompanyV3Op___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(CreateCompanyV3Op);
        ...
        public static class Cloning
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (CreateCompanyV3Op)systemUnderTest.Clone();
            ...
            public static void DeepClone___Should_deep_clone_object___When_called()
            {
                ...
                if (systemUnderTest.CompanyToCreate == null)
                {
                    actual.CompanyToCreate.AsTest().Must().BeNull();
                }
                else
                {
                    actual.CompanyToCreate.AsTest().Must().NotBeSameReferenceAs(systemUnderTest.CompanyToCreate);
                }
            }
            ...
            {
                var propertyNames = new string[] { "CompanyToCreate" };
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (CreateCompanyV3Op)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach(var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(CreateCompanyV3Op).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class Serialization
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<CreateCompanyV3Op>();
        ...
        public static class Equality
        {
            ...
            {
                // Arrange
                CreateCompanyV3Op systemUnderTest1 = null;
                CreateCompanyV3Op systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    CreateCompanyV3Op systemUnderTest = null;
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_CreateCompanyV3Op___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_CreateCompanyV3Op___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_CreateCompanyV3Op___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_CreateCompanyV3Op___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_CreateCompanyV3Op___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
