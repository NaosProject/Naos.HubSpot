...
namespace Naos.HubSpot.Domain.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<ContactV3> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<ContactV3>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<ContactV3>
                {
                    Name = "Default Code Generated Scenario",
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<ContactV3>();

                        var result = new SystemUnderTestExpectedStringRepresentation<ContactV3>
                        {
                            SystemUnderTest = systemUnderTest,
                            ExpectedStringRepresentation = Invariant($"Naos.HubSpot.Domain.ContactV3: Properties = {systemUnderTest.Properties?.ToString() ?? "<null>"}."),
                        };
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<ContactV3> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<ContactV3>()
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<ContactV3>
                {
                    Name = "constructor should throw ArgumentNullException when parameter 'properties' is null scenario",
                    ConstructionFunc = () =>
                    {
                        var result = new ContactV3(
                                             null);
            ...
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<ContactV3>
                {
                    ...
                    ConstructionFunc = () =>
                    {
                        var referenceObject = A.Dummy<ContactV3>();
        ...
        private static readonly ConstructorPropertyAssignmentTestScenarios<ContactV3> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<ContactV3>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<ContactV3>
                {
                    ...
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        ...
                        var result = new SystemUnderTestExpectedPropertyValue<ContactV3>
                        {
                            SystemUnderTest = new ContactV3(
        ...
        private static readonly DeepCloneWithTestScenarios<ContactV3> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<ContactV3>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<ContactV3>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<ContactV3>().ThatIs(_ => !systemUnderTest.Properties.IsEqualTo(_.Properties));

                        var result = new SystemUnderTestDeepCloneWithValue<ContactV3>
                        {
                            SystemUnderTest = systemUnderTest,
        ...
        private static readonly ContactV3 ReferenceObjectForEquatableTestScenarios = A.Dummy<ContactV3>();

        private static readonly EquatableTestScenarios<ContactV3> EquatableTestScenarios = new EquatableTestScenarios<ContactV3>()
            .AddScenario(() =>
                new EquatableTestScenario<ContactV3>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new ContactV3[]
                    {
                        new ContactV3(
                                ReferenceObjectForEquatableTestScenarios.Properties),
                    },
                    ObjectsThatAreNotEqualToReferenceObject = new ContactV3[]
                    {
                        new ContactV3(
                                A.Dummy<ContactV3>().Whose(_ => !_.Properties.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Properties)).Properties),
                    },
        ...
        public static class Structural
        {
            ...
            public static void ContactV3___Should_implement_IModel_of_ContactV3___When_reflecting()
            {
                // Arrange
                var type = typeof(ContactV3);

                var expectedModelMethods = typeof(IModel<ContactV3>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<ContactV3>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void ContactV3___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(ContactV3);
        ...
        public static class Cloning
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (ContactV3)systemUnderTest.Clone();
            ...
            public static void DeepCloneWith___Should_deep_clone_object_and_replace_the_associated_property_with_the_provided_value___When_called()
            {
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (ContactV3)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach(var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(ContactV3).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class Serialization
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<ContactV3>();
        ...
        public static class Equality
        {
            ...
            {
                // Arrange
                ContactV3 systemUnderTest1 = null;
                ContactV3 systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    ContactV3 systemUnderTest = null;
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ContactV3___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ContactV3___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ContactV3___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ContactV3___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ContactV3___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
