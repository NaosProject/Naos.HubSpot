...
namespace Naos.HubSpot.Domain.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<RemoveCompanyByHubSpotIdV3Op> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<RemoveCompanyByHubSpotIdV3Op>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<RemoveCompanyByHubSpotIdV3Op>
                {
                    Name = "Default Code Generated Scenario",
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<RemoveCompanyByHubSpotIdV3Op>();

                        var result = new SystemUnderTestExpectedStringRepresentation<RemoveCompanyByHubSpotIdV3Op>
                        {
                            SystemUnderTest = systemUnderTest,
                            ExpectedStringRepresentation = Invariant($"Naos.HubSpot.Domain.RemoveCompanyByHubSpotIdV3Op: HubSpotId = {systemUnderTest.HubSpotId?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}."),
                        };
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<RemoveCompanyByHubSpotIdV3Op> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<RemoveCompanyByHubSpotIdV3Op>()
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<RemoveCompanyByHubSpotIdV3Op>
                {
                    Name = "constructor should throw ArgumentNullException when parameter 'hubSpotId' is null scenario",
                    ConstructionFunc = () =>
                    {
                        var result = new RemoveCompanyByHubSpotIdV3Op(
                                             null);
        ...
        private static readonly ConstructorPropertyAssignmentTestScenarios<RemoveCompanyByHubSpotIdV3Op> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<RemoveCompanyByHubSpotIdV3Op>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<RemoveCompanyByHubSpotIdV3Op>
                {
                    Name = "HubSpotId should return same 'hubSpotId' parameter passed to constructor when getting",
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        var referenceObject = A.Dummy<RemoveCompanyByHubSpotIdV3Op>();

                        var result = new SystemUnderTestExpectedPropertyValue<RemoveCompanyByHubSpotIdV3Op>
                        {
                            SystemUnderTest = new RemoveCompanyByHubSpotIdV3Op(
        ...
        private static readonly DeepCloneWithTestScenarios<RemoveCompanyByHubSpotIdV3Op> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<RemoveCompanyByHubSpotIdV3Op>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<RemoveCompanyByHubSpotIdV3Op>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<RemoveCompanyByHubSpotIdV3Op>().ThatIs(_ => !systemUnderTest.HubSpotId.IsEqualTo(_.HubSpotId));

                        var result = new SystemUnderTestDeepCloneWithValue<RemoveCompanyByHubSpotIdV3Op>
                        {
                            SystemUnderTest = systemUnderTest,
        ...
        private static readonly RemoveCompanyByHubSpotIdV3Op ReferenceObjectForEquatableTestScenarios = A.Dummy<RemoveCompanyByHubSpotIdV3Op>();

        private static readonly EquatableTestScenarios<RemoveCompanyByHubSpotIdV3Op> EquatableTestScenarios = new EquatableTestScenarios<RemoveCompanyByHubSpotIdV3Op>()
            .AddScenario(() =>
                new EquatableTestScenario<RemoveCompanyByHubSpotIdV3Op>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new RemoveCompanyByHubSpotIdV3Op[]
                    {
                        new RemoveCompanyByHubSpotIdV3Op(
                                ReferenceObjectForEquatableTestScenarios.HubSpotId),
                    },
                    ObjectsThatAreNotEqualToReferenceObject = new RemoveCompanyByHubSpotIdV3Op[]
                    {
                        new RemoveCompanyByHubSpotIdV3Op(
                                A.Dummy<RemoveCompanyByHubSpotIdV3Op>().Whose(_ => !_.HubSpotId.IsEqualTo(ReferenceObjectForEquatableTestScenarios.HubSpotId)).HubSpotId),
                    },
        ...
        public static class Structural
        {
            ...
            public static void RemoveCompanyByHubSpotIdV3Op___Should_implement_IModel_of_RemoveCompanyByHubSpotIdV3Op___When_reflecting()
            {
                // Arrange
                var type = typeof(RemoveCompanyByHubSpotIdV3Op);

                var expectedModelMethods = typeof(IModel<RemoveCompanyByHubSpotIdV3Op>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<RemoveCompanyByHubSpotIdV3Op>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void RemoveCompanyByHubSpotIdV3Op___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(RemoveCompanyByHubSpotIdV3Op);
        ...
        public static class Cloning
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (RemoveCompanyByHubSpotIdV3Op)systemUnderTest.Clone();
            ...
            public static void DeepCloneWith___Should_deep_clone_object_and_replace_the_associated_property_with_the_provided_value___When_called()
            {
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (RemoveCompanyByHubSpotIdV3Op)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach(var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(RemoveCompanyByHubSpotIdV3Op).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class Serialization
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<RemoveCompanyByHubSpotIdV3Op>();
        ...
        public static class Equality
        {
            ...
            {
                // Arrange
                RemoveCompanyByHubSpotIdV3Op systemUnderTest1 = null;
                RemoveCompanyByHubSpotIdV3Op systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    RemoveCompanyByHubSpotIdV3Op systemUnderTest = null;
            ...
            public static void Equals_with_ReturningOperationBase___Should_return_false___When_parameter_other_is_null()
            {
                ...
                {
                    // Arrange
                    ReturningOperationBase<CompanyV3> systemUnderTest = null;

                    // Act
                    var actual = scenario.ReferenceObject.Equals((ReturningOperationBase<CompanyV3>)systemUnderTest);
            ...
            public static void Equals_with_ReturningOperationBase___Should_return_true___When_parameter_other_is_same_object()
            {
                ...
                {
                    // Arrange, Act
                    var actual = scenario.ReferenceObject.Equals((ReturningOperationBase<CompanyV3>)scenario.ReferenceObject);
            ...
            public static void Equals_with_ReturningOperationBase___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                ...
                {
                    // Arrange, Act
                    var actuals = scenario.ObjectsThatDeriveFromScenarioTypeButAreNotOfTheSameTypeAsReferenceObject.Select(_ => scenario.ReferenceObject.Equals((ReturningOperationBase<CompanyV3>)_)).ToList();
            ...
            public static void Equals_with_ReturningOperationBase___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                ...
                {
                    // Arrange, Act
                    var actuals = scenario.ObjectsThatAreNotEqualToReferenceObject.Select(_ => scenario.ReferenceObject.Equals((ReturningOperationBase<CompanyV3>)_)).ToList();
            ...
            public static void Equals_with_ReturningOperationBase___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                ...
                {
                    // Arrange, Act
                    var actuals = scenario.ObjectsThatAreEqualToButNotTheSameAsReferenceObject.Select(_ => scenario.ReferenceObject.Equals((ReturningOperationBase<CompanyV3>)_)).ToList();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_RemoveCompanyByHubSpotIdV3Op___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_RemoveCompanyByHubSpotIdV3Op___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_RemoveCompanyByHubSpotIdV3Op___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_RemoveCompanyByHubSpotIdV3Op___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_RemoveCompanyByHubSpotIdV3Op___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
