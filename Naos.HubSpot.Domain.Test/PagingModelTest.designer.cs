...
namespace Naos.HubSpot.Domain.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<PagingModel> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<PagingModel>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<PagingModel>
                {
                    Name = "Default Code Generated Scenario",
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<PagingModel>();

                        var result = new SystemUnderTestExpectedStringRepresentation<PagingModel>
                        {
                            SystemUnderTest = systemUnderTest,
                            ExpectedStringRepresentation = Invariant($"Naos.HubSpot.Domain.PagingModel: Next = {systemUnderTest.Next?.ToString() ?? "<null>"}, Prev = {systemUnderTest.Prev?.ToString() ?? "<null>"}."),
                        };
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<PagingModel> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<PagingModel>()
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<PagingModel>
                {
                    Name = "constructor should throw ArgumentNullException when parameter 'prev' is null scenario",
                    ConstructionFunc = () =>
                    {
                        var referenceObject = A.Dummy<PagingModel>();
                    ...
                    ExpectedExceptionMessageContains = new[] { "prev" },
                })
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<PagingModel>
                {
                    Name = "constructor should throw ArgumentNullException when parameter 'next' is null scenario",
                    ConstructionFunc = () =>
                    {
                        var referenceObject = A.Dummy<PagingModel>();

                        var result = new PagingModel(
                                             referenceObject.Prev,
                                             null);

                        return result;
                    },
                    ExpectedExceptionType = typeof(ArgumentNullException),
                    ExpectedExceptionMessageContains = new[] { "next" },
                });

        private static readonly ConstructorPropertyAssignmentTestScenarios<PagingModel> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<PagingModel>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<PagingModel>
                {
                    Name = "Prev should return same 'prev' parameter passed to constructor when getting",
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        var referenceObject = A.Dummy<PagingModel>();

                        var result = new SystemUnderTestExpectedPropertyValue<PagingModel>
                        {
                            SystemUnderTest = new PagingModel(
                                                      referenceObject.Prev,
                                                      referenceObject.Next),
                            ExpectedPropertyValue = referenceObject.Prev,
                        };
            ...
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<PagingModel>
                {
                    Name = "Next should return same 'next' parameter passed to constructor when getting",
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        var referenceObject = A.Dummy<PagingModel>();
                        ...
                        var result = new SystemUnderTestExpectedPropertyValue<PagingModel>
                        {
                            SystemUnderTest = new PagingModel(
                                                      referenceObject.Prev,
                                                      referenceObject.Next),
                            ExpectedPropertyValue = referenceObject.Next,
                        };
        ...
        private static readonly DeepCloneWithTestScenarios<PagingModel> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<PagingModel>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<PagingModel>
                {
                    Name = "DeepCloneWithNext should deep clone object and replace Next with the provided next",
                    WithPropertyName = "Next",
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<PagingModel>();

                        var referenceObject = A.Dummy<PagingModel>().ThatIs(_ => !systemUnderTest.Next.IsEqualTo(_.Next));

                        var result = new SystemUnderTestDeepCloneWithValue<PagingModel>
                        {
                            SystemUnderTest = systemUnderTest,
                            DeepCloneWithValue = referenceObject.Next,
                        };
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<PagingModel>
                {
                    Name = "DeepCloneWithPrev should deep clone object and replace Prev with the provided prev",
                    WithPropertyName = "Prev",
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<PagingModel>();

                        var referenceObject = A.Dummy<PagingModel>().ThatIs(_ => !systemUnderTest.Prev.IsEqualTo(_.Prev));

                        var result = new SystemUnderTestDeepCloneWithValue<PagingModel>
                        {
                            SystemUnderTest = systemUnderTest,
                            DeepCloneWithValue = referenceObject.Prev,
                        };
        ...
        private static readonly PagingModel ReferenceObjectForEquatableTestScenarios = A.Dummy<PagingModel>();

        private static readonly EquatableTestScenarios<PagingModel> EquatableTestScenarios = new EquatableTestScenarios<PagingModel>()
            .AddScenario(() =>
                new EquatableTestScenario<PagingModel>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new PagingModel[]
                    {
                        new PagingModel(
                                ReferenceObjectForEquatableTestScenarios.Prev,
                                ReferenceObjectForEquatableTestScenarios.Next),
                    },
                    ObjectsThatAreNotEqualToReferenceObject = new PagingModel[]
                    {
                        new PagingModel(
                                ReferenceObjectForEquatableTestScenarios.Prev,
                                A.Dummy<PagingModel>().Whose(_ => !_.Next.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Next)).Next),
                        new PagingModel(
                                A.Dummy<PagingModel>().Whose(_ => !_.Prev.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Prev)).Prev,
                                ReferenceObjectForEquatableTestScenarios.Next),
                    },
        ...
        public static class Structural
        {
            ...
            public static void PagingModel___Should_implement_IModel_of_PagingModel___When_reflecting()
            {
                // Arrange
                var type = typeof(PagingModel);

                var expectedModelMethods = typeof(IModel<PagingModel>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<PagingModel>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void PagingModel___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(PagingModel);
        ...
        public static class Cloning
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (PagingModel)systemUnderTest.Clone();
            ...
            public static void DeepClone___Should_deep_clone_object___When_called()
            {
                ...
                if (systemUnderTest.Next == null)
                {
                    actual.Next.AsTest().Must().BeNull();
                }
                else
                {
                    actual.Next.AsTest().Must().NotBeSameReferenceAs(systemUnderTest.Next);
                }

                if (systemUnderTest.Prev == null)
                {
                    actual.Prev.AsTest().Must().BeNull();
                }
                else
                {
                    actual.Prev.AsTest().Must().NotBeSameReferenceAs(systemUnderTest.Prev);
                }
            }
            ...
            {
                var propertyNames = new string[] { "Next", "Prev" };
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (PagingModel)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach(var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(PagingModel).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class Serialization
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<PagingModel>();
        ...
        public static class Equality
        {
            ...
            {
                // Arrange
                PagingModel systemUnderTest1 = null;
                PagingModel systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    PagingModel systemUnderTest = null;
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_PagingModel___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_PagingModel___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_PagingModel___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_PagingModel___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_PagingModel___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
