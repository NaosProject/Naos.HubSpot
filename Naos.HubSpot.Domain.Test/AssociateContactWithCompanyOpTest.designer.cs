    ...
    public static partial class AssociateContactWithCompanyOpTest
    {
                ...
                new StringRepresentationTestScenario<AssociateContactWithCompanyOp>
                {
                    ...
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        ...
                        var result = new SystemUnderTestExpectedStringRepresentation<AssociateContactWithCompanyOp>
                        {
                            ...
                            ExpectedStringRepresentation = Invariant($"Naos.HubSpot.Domain.AssociateContactWithCompanyOp: ContactHubSpotId = {systemUnderTest.ContactHubSpotId.ToString(CultureInfo.InvariantCulture) ?? "<null>"}, CompanyHubSpotId = {systemUnderTest.CompanyHubSpotId.ToString(CultureInfo.InvariantCulture) ?? "<null>"}."),
                        };
        ...
        private static readonly ConstructorPropertyAssignmentTestScenarios<AssociateContactWithCompanyOp> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<AssociateContactWithCompanyOp>()
            .AddScenario(() =>
                ...
                {
                    Name = "ContactHubSpotId should return same 'contactHubSpotId' parameter passed to constructor when getting",
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        ...
                        var result = new SystemUnderTestExpectedPropertyValue<AssociateContactWithCompanyOp>
                        {
                            SystemUnderTest = new AssociateContactWithCompanyOp(
                                                      referenceObject.ContactHubSpotId,
                                                      referenceObject.CompanyHubSpotId),
                            ExpectedPropertyValue = referenceObject.ContactHubSpotId,
                        };

                        return result;
                    },
                    PropertyName = "ContactHubSpotId",
                })
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<AssociateContactWithCompanyOp>
                {
                    Name = "CompanyHubSpotId should return same 'companyHubSpotId' parameter passed to constructor when getting",
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        var referenceObject = A.Dummy<AssociateContactWithCompanyOp>();
                        ...
                        var result = new SystemUnderTestExpectedPropertyValue<AssociateContactWithCompanyOp>
                        {
                            SystemUnderTest = new AssociateContactWithCompanyOp(
                                                      referenceObject.ContactHubSpotId,
                                                      referenceObject.CompanyHubSpotId),
                            ExpectedPropertyValue = referenceObject.CompanyHubSpotId,
                        };

                        return result;
                    },
                    PropertyName = "CompanyHubSpotId",
                });
        ...
        private static readonly DeepCloneWithTestScenarios<AssociateContactWithCompanyOp> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<AssociateContactWithCompanyOp>()
            .AddScenario(() =>
                ...
                {
                    Name = "DeepCloneWithContactHubSpotId should deep clone object and replace ContactHubSpotId with the provided contactHubSpotId",
                    WithPropertyName = "ContactHubSpotId",
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<AssociateContactWithCompanyOp>();

                        var referenceObject = A.Dummy<AssociateContactWithCompanyOp>().ThatIs(_ => !systemUnderTest.ContactHubSpotId.IsEqualTo(_.ContactHubSpotId));

                        var result = new SystemUnderTestDeepCloneWithValue<AssociateContactWithCompanyOp>
                        {
                            SystemUnderTest = systemUnderTest,
                            DeepCloneWithValue = referenceObject.ContactHubSpotId,
                        };
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<AssociateContactWithCompanyOp>
                {
                    Name = "DeepCloneWithCompanyHubSpotId should deep clone object and replace CompanyHubSpotId with the provided companyHubSpotId",
                    WithPropertyName = "CompanyHubSpotId",
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<AssociateContactWithCompanyOp>();

                        var referenceObject = A.Dummy<AssociateContactWithCompanyOp>().ThatIs(_ => !systemUnderTest.CompanyHubSpotId.IsEqualTo(_.CompanyHubSpotId));

                        var result = new SystemUnderTestDeepCloneWithValue<AssociateContactWithCompanyOp>
                        {
                            SystemUnderTest = systemUnderTest,
                            DeepCloneWithValue = referenceObject.CompanyHubSpotId,
                        };
                ...
                new EquatableTestScenario<AssociateContactWithCompanyOp>
                {
                    ...
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new AssociateContactWithCompanyOp[]
                    {
                        new AssociateContactWithCompanyOp(
                                ReferenceObjectForEquatableTestScenarios.ContactHubSpotId,
                                ReferenceObjectForEquatableTestScenarios.CompanyHubSpotId),
                    },
                    ObjectsThatAreNotEqualToReferenceObject = new AssociateContactWithCompanyOp[]
                    {
                        new AssociateContactWithCompanyOp(
                                A.Dummy<AssociateContactWithCompanyOp>().Whose(_ => !_.ContactHubSpotId.IsEqualTo(ReferenceObjectForEquatableTestScenarios.ContactHubSpotId)).ContactHubSpotId,
                                ReferenceObjectForEquatableTestScenarios.CompanyHubSpotId),
                        new AssociateContactWithCompanyOp(
                                ReferenceObjectForEquatableTestScenarios.ContactHubSpotId,
                                A.Dummy<AssociateContactWithCompanyOp>().Whose(_ => !_.CompanyHubSpotId.IsEqualTo(ReferenceObjectForEquatableTestScenarios.CompanyHubSpotId)).CompanyHubSpotId),
                    },
        ...
        public static class Cloning
        {
            ...
            {
                var propertyNames = new string[] { "ContactHubSpotId", "CompanyHubSpotId" };
