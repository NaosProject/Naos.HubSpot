...
namespace Naos.HubSpot.Domain.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<CreateContactOp> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<CreateContactOp>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<CreateContactOp>
                {
                    Name = "Default Code Generated Scenario",
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<CreateContactOp>();

                        var result = new SystemUnderTestExpectedStringRepresentation<CreateContactOp>
                        {
                            SystemUnderTest = systemUnderTest,
                            ExpectedStringRepresentation = Invariant($"Naos.HubSpot.Domain.CreateContactOp: ContactToCreate = {systemUnderTest.ContactToCreate?.ToString() ?? "<null>"}."),
                        };
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<CreateContactOp> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<CreateContactOp>()
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<CreateContactOp>
                {
                    Name = "constructor should throw ArgumentNullException when parameter 'contactToCreate' is null scenario",
                    ConstructionFunc = () =>
                    {
                        var result = new CreateContactOp(
                                             null);
        ...
        private static readonly ConstructorPropertyAssignmentTestScenarios<CreateContactOp> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<CreateContactOp>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<CreateContactOp>
                {
                    Name = "ContactToCreate should return same 'contactToCreate' parameter passed to constructor when getting",
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        var referenceObject = A.Dummy<CreateContactOp>();

                        var result = new SystemUnderTestExpectedPropertyValue<CreateContactOp>
                        {
                            SystemUnderTest = new CreateContactOp(
        ...
        private static readonly DeepCloneWithTestScenarios<CreateContactOp> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<CreateContactOp>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<CreateContactOp>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<CreateContactOp>().ThatIs(_ => !systemUnderTest.ContactToCreate.IsEqualTo(_.ContactToCreate));

                        var result = new SystemUnderTestDeepCloneWithValue<CreateContactOp>
                        {
                            SystemUnderTest = systemUnderTest,
        ...
        private static readonly CreateContactOp ReferenceObjectForEquatableTestScenarios = A.Dummy<CreateContactOp>();

        private static readonly EquatableTestScenarios<CreateContactOp> EquatableTestScenarios = new EquatableTestScenarios<CreateContactOp>()
            .AddScenario(() =>
                new EquatableTestScenario<CreateContactOp>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new CreateContactOp[]
                    {
                        new CreateContactOp(
                                ReferenceObjectForEquatableTestScenarios.ContactToCreate),
                    },
                    ObjectsThatAreNotEqualToReferenceObject = new CreateContactOp[]
                    {
                        new CreateContactOp(
                                A.Dummy<CreateContactOp>().Whose(_ => !_.ContactToCreate.IsEqualTo(ReferenceObjectForEquatableTestScenarios.ContactToCreate)).ContactToCreate),
                    },
        ...
        public static class Structural
        {
            ...
            {
                // Arrange
                var type = typeof(CreateContactOp);

                var expectedModelMethods = typeof(IModel<CreateContactOp>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<CreateContactOp>));
        ...
        public static class Cloning
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (CreateContactOp)systemUnderTest.Clone();
            ...
            public static void DeepCloneWith___Should_deep_clone_object_and_replace_the_associated_property_with_the_provided_value___When_called()
            {
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (CreateContactOp)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach(var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(CreateContactOp).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class Serialization
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<CreateContactOp>();
        ...
        public static class Equality
        {
            ...
            {
                // Arrange
                CreateContactOp systemUnderTest1 = null;
                CreateContactOp systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    CreateContactOp systemUnderTest = null;
