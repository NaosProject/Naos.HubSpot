...
namespace Naos.HubSpot.Domain.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<DeleteContactOp> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<DeleteContactOp>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<DeleteContactOp>
                {
                    Name = "Default Code Generated Scenario",
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<DeleteContactOp>();

                        var result = new SystemUnderTestExpectedStringRepresentation<DeleteContactOp>
                        {
                            SystemUnderTest = systemUnderTest,
                            ExpectedStringRepresentation = Invariant($"Naos.HubSpot.Domain.DeleteContactOp: Vid = {systemUnderTest.Vid.ToString(CultureInfo.InvariantCulture) ?? "<null>"}."),
                        };
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<DeleteContactOp> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<DeleteContactOp>();

        private static readonly ConstructorPropertyAssignmentTestScenarios<DeleteContactOp> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<DeleteContactOp>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<DeleteContactOp>
                {
                    Name = "Vid should return same 'vid' parameter passed to constructor when getting",
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        var referenceObject = A.Dummy<DeleteContactOp>();

                        var result = new SystemUnderTestExpectedPropertyValue<DeleteContactOp>
                        {
                            SystemUnderTest = new DeleteContactOp(
                                                      referenceObject.Vid),
        ...
        private static readonly DeepCloneWithTestScenarios<DeleteContactOp> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<DeleteContactOp>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<DeleteContactOp>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<DeleteContactOp>().ThatIs(_ => !systemUnderTest.Vid.IsEqualTo(_.Vid));

                        var result = new SystemUnderTestDeepCloneWithValue<DeleteContactOp>
                        {
                            SystemUnderTest = systemUnderTest,
        ...
        private static readonly DeleteContactOp ReferenceObjectForEquatableTestScenarios = A.Dummy<DeleteContactOp>();

        private static readonly EquatableTestScenarios<DeleteContactOp> EquatableTestScenarios = new EquatableTestScenarios<DeleteContactOp>()
            .AddScenario(() =>
                new EquatableTestScenario<DeleteContactOp>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new DeleteContactOp[]
                    {
                        new DeleteContactOp(
                                ReferenceObjectForEquatableTestScenarios.Vid),
                    },
                    ObjectsThatAreNotEqualToReferenceObject = new DeleteContactOp[]
                    {
                        new DeleteContactOp(
                                A.Dummy<DeleteContactOp>().Whose(_ => !_.Vid.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Vid)).Vid),
                    },
        ...
        public static class Structural
        {
            ...
            public static void DeleteContactOp___Should_implement_IModel_of_DeleteContactOp___When_reflecting()
            {
                // Arrange
                var type = typeof(DeleteContactOp);

                var expectedModelMethods = typeof(IModel<DeleteContactOp>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<DeleteContactOp>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void DeleteContactOp___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(DeleteContactOp);
        ...
        public static class Cloning
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (DeleteContactOp)systemUnderTest.Clone();
            ...
            {
                var propertyNames = new string[] { "Vid" };
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (DeleteContactOp)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach(var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(DeleteContactOp).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class Serialization
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<DeleteContactOp>();
        ...
        public static class Equality
        {
            ...
            {
                // Arrange
                DeleteContactOp systemUnderTest1 = null;
                DeleteContactOp systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    DeleteContactOp systemUnderTest = null;
            ...
            public static void Equals_with_ReturningOperationBase___Should_return_false___When_parameter_other_is_null()
            {
                ...
                {
                    // Arrange
                    ReturningOperationBase<DeleteContactResponse> systemUnderTest = null;

                    // Act
                    var actual = scenario.ReferenceObject.Equals((ReturningOperationBase<DeleteContactResponse>)systemUnderTest);
            ...
            public static void Equals_with_ReturningOperationBase___Should_return_true___When_parameter_other_is_same_object()
            {
                ...
                {
                    // Arrange, Act
                    var actual = scenario.ReferenceObject.Equals((ReturningOperationBase<DeleteContactResponse>)scenario.ReferenceObject);
            ...
            public static void Equals_with_ReturningOperationBase___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                ...
                {
                    // Arrange, Act
                    var actuals = scenario.ObjectsThatDeriveFromScenarioTypeButAreNotOfTheSameTypeAsReferenceObject.Select(_ => scenario.ReferenceObject.Equals((ReturningOperationBase<DeleteContactResponse>)_)).ToList();
            ...
            public static void Equals_with_ReturningOperationBase___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                ...
                {
                    // Arrange, Act
                    var actuals = scenario.ObjectsThatAreNotEqualToReferenceObject.Select(_ => scenario.ReferenceObject.Equals((ReturningOperationBase<DeleteContactResponse>)_)).ToList();
            ...
            public static void Equals_with_ReturningOperationBase___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                ...
                {
                    // Arrange, Act
                    var actuals = scenario.ObjectsThatAreEqualToButNotTheSameAsReferenceObject.Select(_ => scenario.ReferenceObject.Equals((ReturningOperationBase<DeleteContactResponse>)_)).ToList();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_DeleteContactOp___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_DeleteContactOp___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_DeleteContactOp___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_DeleteContactOp___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_DeleteContactOp___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
