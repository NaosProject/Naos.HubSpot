...
namespace Naos.HubSpot.Domain.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<GetAllCompaniesOp> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<GetAllCompaniesOp>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<GetAllCompaniesOp>
                {
                    Name = "Default Code Generated Scenario",
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<GetAllCompaniesOp>();

                        var result = new SystemUnderTestExpectedStringRepresentation<GetAllCompaniesOp>
                        {
                            SystemUnderTest = systemUnderTest,
                            ExpectedStringRepresentation = Invariant($"Naos.HubSpot.Domain.GetAllCompaniesOp: PropertyNamesToInclude = {systemUnderTest.PropertyNamesToInclude?.ToString() ?? "<null>"}."),
                        };
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<GetAllCompaniesOp> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<GetAllCompaniesOp>()
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<GetAllCompaniesOp>
                {
                    Name = "constructor should throw ArgumentNullException when parameter 'propertyNamesToInclude' is null scenario",
                    ConstructionFunc = () =>
                    {
                        var result = new GetAllCompaniesOp(
                                             null);

                        return result;
                    },
                    ExpectedExceptionType = typeof(ArgumentNullException),
                    ExpectedExceptionMessageContains = new[] { "propertyNamesToInclude" },
                })
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<GetAllCompaniesOp>
                {
                    Name = "constructor should throw ArgumentException when parameter 'propertyNamesToInclude' is an empty enumerable scenario",
                    ConstructionFunc = () =>
                    {
                        var result = new GetAllCompaniesOp(
                                             new List<string>());
                    ...
                    ExpectedExceptionMessageContains = new[] { "propertyNamesToInclude", "is an empty enumerable" },
                })
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<GetAllCompaniesOp>
                {
                    Name = "constructor should throw ArgumentException when parameter 'propertyNamesToInclude' contains a null element scenario",
                    ConstructionFunc = () =>
                    {
                        var referenceObject = A.Dummy<GetAllCompaniesOp>();

                        var result = new GetAllCompaniesOp(
                                             new string[0].Concat(referenceObject.PropertyNamesToInclude).Concat(new string[] { null }).Concat(referenceObject.PropertyNamesToInclude).ToList());

                        return result;
                    },
                    ExpectedExceptionType = typeof(ArgumentException),
                    ExpectedExceptionMessageContains = new[] { "propertyNamesToInclude", "contains at least one null element" },
                });

        private static readonly ConstructorPropertyAssignmentTestScenarios<GetAllCompaniesOp> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<GetAllCompaniesOp>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<GetAllCompaniesOp>
                {
                    Name = "PropertyNamesToInclude should return same 'propertyNamesToInclude' parameter passed to constructor when getting",
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        var referenceObject = A.Dummy<GetAllCompaniesOp>();

                        var result = new SystemUnderTestExpectedPropertyValue<GetAllCompaniesOp>
                        {
                            SystemUnderTest = new GetAllCompaniesOp(
                                                      referenceObject.PropertyNamesToInclude),
                            ExpectedPropertyValue = referenceObject.PropertyNamesToInclude,
                        };

                        return result;
                    },
                    PropertyName = "PropertyNamesToInclude",
                });

        private static readonly DeepCloneWithTestScenarios<GetAllCompaniesOp> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<GetAllCompaniesOp>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<GetAllCompaniesOp>
                {
                    Name = "DeepCloneWithPropertyNamesToInclude should deep clone object and replace PropertyNamesToInclude with the provided propertyNamesToInclude",
                    WithPropertyName = "PropertyNamesToInclude",
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<GetAllCompaniesOp>();

                        var referenceObject = A.Dummy<GetAllCompaniesOp>().ThatIs(_ => !systemUnderTest.PropertyNamesToInclude.IsEqualTo(_.PropertyNamesToInclude));

                        var result = new SystemUnderTestDeepCloneWithValue<GetAllCompaniesOp>
                        {
                            SystemUnderTest = systemUnderTest,
                            DeepCloneWithValue = referenceObject.PropertyNamesToInclude,
                        };
        ...
        private static readonly GetAllCompaniesOp ReferenceObjectForEquatableTestScenarios = A.Dummy<GetAllCompaniesOp>();

        private static readonly EquatableTestScenarios<GetAllCompaniesOp> EquatableTestScenarios = new EquatableTestScenarios<GetAllCompaniesOp>()
            .AddScenario(() =>
                new EquatableTestScenario<GetAllCompaniesOp>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new GetAllCompaniesOp[]
                    {
                        new GetAllCompaniesOp(
                                ReferenceObjectForEquatableTestScenarios.PropertyNamesToInclude),
                    },
                    ObjectsThatAreNotEqualToReferenceObject = new GetAllCompaniesOp[]
                    {
                        new GetAllCompaniesOp(
                                A.Dummy<GetAllCompaniesOp>().Whose(_ => !_.PropertyNamesToInclude.IsEqualTo(ReferenceObjectForEquatableTestScenarios.PropertyNamesToInclude)).PropertyNamesToInclude),
                    },
                    ObjectsThatAreNotOfTheSameTypeAsReferenceObject = new object[]
                    {
                        ...
                        A.Dummy<AssociateContactWithCompanyV3Op>(),
        ...
        public static class Structural
        {
            ...
            public static void GetAllCompaniesOp___Should_implement_IModel_of_GetAllCompaniesOp___When_reflecting()
            {
                // Arrange
                var type = typeof(GetAllCompaniesOp);

                var expectedModelMethods = typeof(IModel<GetAllCompaniesOp>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<GetAllCompaniesOp>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void GetAllCompaniesOp___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(GetAllCompaniesOp);
        ...
        public static class Cloning
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (GetAllCompaniesOp)systemUnderTest.Clone();
            ...
            public static void DeepClone___Should_deep_clone_object___When_called()
            {
                ...
                if (systemUnderTest.PropertyNamesToInclude == null)
                {
                    actual.PropertyNamesToInclude.AsTest().Must().BeNull();
                }
                else
                {
                    actual.PropertyNamesToInclude.AsTest().Must().NotBeSameReferenceAs(systemUnderTest.PropertyNamesToInclude);
                }
            }
            ...
            {
                var propertyNames = new string[] { "PropertyNamesToInclude" };
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (GetAllCompaniesOp)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach(var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(GetAllCompaniesOp).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class Serialization
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<GetAllCompaniesOp>();
        ...
        public static class Equality
        {
            ...
            {
                // Arrange
                GetAllCompaniesOp systemUnderTest1 = null;
                GetAllCompaniesOp systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    GetAllCompaniesOp systemUnderTest = null;
            ...
            public static void Equals_with_ReturningOperationBase___Should_return_false___When_parameter_other_is_null()
            {
                ...
                {
                    // Arrange
                    ReturningOperationBase<IReadOnlyCollection<Company>> systemUnderTest = null;

                    // Act
                    var actual = scenario.ReferenceObject.Equals((ReturningOperationBase<IReadOnlyCollection<Company>>)systemUnderTest);
            ...
            public static void Equals_with_ReturningOperationBase___Should_return_true___When_parameter_other_is_same_object()
            {
                ...
                {
                    // Arrange, Act
                    var actual = scenario.ReferenceObject.Equals((ReturningOperationBase<IReadOnlyCollection<Company>>)scenario.ReferenceObject);
            ...
            public static void Equals_with_ReturningOperationBase___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                ...
                {
                    // Arrange, Act
                    var actuals = scenario.ObjectsThatDeriveFromScenarioTypeButAreNotOfTheSameTypeAsReferenceObject.Select(_ => scenario.ReferenceObject.Equals((ReturningOperationBase<IReadOnlyCollection<Company>>)_)).ToList();
            ...
            public static void Equals_with_ReturningOperationBase___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                ...
                {
                    // Arrange, Act
                    var actuals = scenario.ObjectsThatAreNotEqualToReferenceObject.Select(_ => scenario.ReferenceObject.Equals((ReturningOperationBase<IReadOnlyCollection<Company>>)_)).ToList();
            ...
            public static void Equals_with_ReturningOperationBase___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                ...
                {
                    // Arrange, Act
                    var actuals = scenario.ObjectsThatAreEqualToButNotTheSameAsReferenceObject.Select(_ => scenario.ReferenceObject.Equals((ReturningOperationBase<IReadOnlyCollection<Company>>)_)).ToList();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_GetAllCompaniesOp___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_GetAllCompaniesOp___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_GetAllCompaniesOp___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_GetAllCompaniesOp___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_GetAllCompaniesOp___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
