...
namespace Naos.HubSpot.Domain.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<DeleteContactPropertyOp> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<DeleteContactPropertyOp>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<DeleteContactPropertyOp>
                {
                    Name = "Default Code Generated Scenario",
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<DeleteContactPropertyOp>();

                        var result = new SystemUnderTestExpectedStringRepresentation<DeleteContactPropertyOp>
                        {
                            SystemUnderTest = systemUnderTest,
                            ExpectedStringRepresentation = Invariant($"Naos.HubSpot.Domain.DeleteContactPropertyOp: PropertyName = {systemUnderTest.PropertyName?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}."),
                        };
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<DeleteContactPropertyOp> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<DeleteContactPropertyOp>()
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<DeleteContactPropertyOp>
                {
                    Name = "constructor should throw ArgumentNullException when parameter 'propertyName' is null scenario",
                    ConstructionFunc = () =>
                    {
                        var result = new DeleteContactPropertyOp(
                                             null);
        ...
        private static readonly ConstructorPropertyAssignmentTestScenarios<DeleteContactPropertyOp> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<DeleteContactPropertyOp>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<DeleteContactPropertyOp>
                {
                    Name = "PropertyName should return same 'propertyName' parameter passed to constructor when getting",
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        var referenceObject = A.Dummy<DeleteContactPropertyOp>();

                        var result = new SystemUnderTestExpectedPropertyValue<DeleteContactPropertyOp>
                        {
                            SystemUnderTest = new DeleteContactPropertyOp(
        ...
        private static readonly DeepCloneWithTestScenarios<DeleteContactPropertyOp> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<DeleteContactPropertyOp>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<DeleteContactPropertyOp>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<DeleteContactPropertyOp>().ThatIs(_ => !systemUnderTest.PropertyName.IsEqualTo(_.PropertyName));

                        var result = new SystemUnderTestDeepCloneWithValue<DeleteContactPropertyOp>
                        {
                            SystemUnderTest = systemUnderTest,
        ...
        private static readonly DeleteContactPropertyOp ReferenceObjectForEquatableTestScenarios = A.Dummy<DeleteContactPropertyOp>();

        private static readonly EquatableTestScenarios<DeleteContactPropertyOp> EquatableTestScenarios = new EquatableTestScenarios<DeleteContactPropertyOp>()
            .AddScenario(() =>
                new EquatableTestScenario<DeleteContactPropertyOp>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new DeleteContactPropertyOp[]
                    {
                        new DeleteContactPropertyOp(
                                ReferenceObjectForEquatableTestScenarios.PropertyName),
                    },
                    ObjectsThatAreNotEqualToReferenceObject = new DeleteContactPropertyOp[]
                    {
                        new DeleteContactPropertyOp(
                                A.Dummy<DeleteContactPropertyOp>().Whose(_ => !_.PropertyName.IsEqualTo(ReferenceObjectForEquatableTestScenarios.PropertyName)).PropertyName),
                    },
        ...
        public static class Structural
        {
            ...
            public static void DeleteContactPropertyOp___Should_implement_IModel_of_DeleteContactPropertyOp___When_reflecting()
            {
                // Arrange
                var type = typeof(DeleteContactPropertyOp);

                var expectedModelMethods = typeof(IModel<DeleteContactPropertyOp>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<DeleteContactPropertyOp>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void DeleteContactPropertyOp___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(DeleteContactPropertyOp);
        ...
        public static class Cloning
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (DeleteContactPropertyOp)systemUnderTest.Clone();
            ...
            {
                var propertyNames = new string[] { "PropertyName" };
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (DeleteContactPropertyOp)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach(var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(DeleteContactPropertyOp).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class Serialization
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<DeleteContactPropertyOp>();
        ...
        public static class Equality
        {
            ...
            {
                // Arrange
                DeleteContactPropertyOp systemUnderTest1 = null;
                DeleteContactPropertyOp systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    DeleteContactPropertyOp systemUnderTest = null;
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_DeleteContactPropertyOp___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_DeleteContactPropertyOp___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_DeleteContactPropertyOp___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_DeleteContactPropertyOp___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_DeleteContactPropertyOp___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
