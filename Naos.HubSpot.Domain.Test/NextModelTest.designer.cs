...
namespace Naos.HubSpot.Domain.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<NextModel> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<NextModel>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<NextModel>
                {
                    Name = "Default Code Generated Scenario",
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<NextModel>();

                        var result = new SystemUnderTestExpectedStringRepresentation<NextModel>
                        {
                            SystemUnderTest = systemUnderTest,
                            ExpectedStringRepresentation = Invariant($"Naos.HubSpot.Domain.NextModel: Link = {systemUnderTest.Link?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}, After = {systemUnderTest.After?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}."),
                        };
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<NextModel> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<NextModel>()
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<NextModel>
                {
                    Name = "constructor should throw ArgumentNullException when parameter 'link' is null scenario",
                    ConstructionFunc = () =>
                    {
                        var referenceObject = A.Dummy<NextModel>();

                        var result = new NextModel(
                                             null,
                                             referenceObject.After);
            ...
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<NextModel>
                {
                    Name = "constructor should throw ArgumentException when parameter 'link' is white space scenario",
                    ConstructionFunc = () =>
                    {
                        var referenceObject = A.Dummy<NextModel>();
                    ...
                    ExpectedExceptionMessageContains = new[] { "link", "white space" },
                })
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<NextModel>
                {
                    Name = "constructor should throw ArgumentNullException when parameter 'after' is null scenario",
                    ConstructionFunc = () =>
                    {
                        var referenceObject = A.Dummy<NextModel>();
                    ...
                    ExpectedExceptionType = typeof(ArgumentNullException),
                    ExpectedExceptionMessageContains = new[] { "after" },
                })
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<NextModel>
                {
                    Name = "constructor should throw ArgumentException when parameter 'after' is white space scenario",
                    ConstructionFunc = () =>
                    {
                        var referenceObject = A.Dummy<NextModel>();
                    ...
                    ExpectedExceptionType = typeof(ArgumentException),
                    ExpectedExceptionMessageContains = new[] { "after", "white space" },
                });

        private static readonly ConstructorPropertyAssignmentTestScenarios<NextModel> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<NextModel>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<NextModel>
                {
                    ...
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        ...
                        var result = new SystemUnderTestExpectedPropertyValue<NextModel>
                        {
            ...
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<NextModel>
                {
                    Name = "After should return same 'after' parameter passed to constructor when getting",
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        var referenceObject = A.Dummy<NextModel>();
                        ...
                        var result = new SystemUnderTestExpectedPropertyValue<NextModel>
                        {
                            SystemUnderTest = new NextModel(
                                                      referenceObject.Link,
                                                      referenceObject.After),
                            ExpectedPropertyValue = referenceObject.After,
                        };
        ...
        private static readonly DeepCloneWithTestScenarios<NextModel> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<NextModel>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<NextModel>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<NextModel>().ThatIs(_ => !systemUnderTest.Link.IsEqualTo(_.Link));

                        var result = new SystemUnderTestDeepCloneWithValue<NextModel>
                        {
                            SystemUnderTest = systemUnderTest,
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<NextModel>
                {
                    Name = "DeepCloneWithAfter should deep clone object and replace After with the provided after",
                    WithPropertyName = "After",
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<NextModel>();

                        var referenceObject = A.Dummy<NextModel>().ThatIs(_ => !systemUnderTest.After.IsEqualTo(_.After));

                        var result = new SystemUnderTestDeepCloneWithValue<NextModel>
                        {
                            SystemUnderTest = systemUnderTest,
                            DeepCloneWithValue = referenceObject.After,
                        };
        ...
        private static readonly NextModel ReferenceObjectForEquatableTestScenarios = A.Dummy<NextModel>();

        private static readonly EquatableTestScenarios<NextModel> EquatableTestScenarios = new EquatableTestScenarios<NextModel>()
            .AddScenario(() =>
                new EquatableTestScenario<NextModel>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new NextModel[]
                    {
                        new NextModel(
                                ReferenceObjectForEquatableTestScenarios.Link,
                                ReferenceObjectForEquatableTestScenarios.After),
                    },
                    ObjectsThatAreNotEqualToReferenceObject = new NextModel[]
                    {
                        new NextModel(
                                A.Dummy<NextModel>().Whose(_ => !_.Link.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Link)).Link,
                                ReferenceObjectForEquatableTestScenarios.After),
                        new NextModel(
                                ReferenceObjectForEquatableTestScenarios.Link,
                                A.Dummy<NextModel>().Whose(_ => !_.After.IsEqualTo(ReferenceObjectForEquatableTestScenarios.After)).After),
                    },
        ...
        public static class Structural
        {
            ...
            public static void NextModel___Should_implement_IModel_of_NextModel___When_reflecting()
            {
                // Arrange
                var type = typeof(NextModel);

                var expectedModelMethods = typeof(IModel<NextModel>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<NextModel>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void NextModel___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(NextModel);
        ...
        public static class Cloning
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (NextModel)systemUnderTest.Clone();
            ...
            {
                var propertyNames = new string[] { "Link", "After" };
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (NextModel)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach(var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(NextModel).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class Serialization
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<NextModel>();
        ...
        public static class Equality
        {
            ...
            {
                // Arrange
                NextModel systemUnderTest1 = null;
                NextModel systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    NextModel systemUnderTest = null;
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_NextModel___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_NextModel___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_NextModel___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_NextModel___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_NextModel___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
