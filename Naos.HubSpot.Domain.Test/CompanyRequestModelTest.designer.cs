...
namespace Naos.HubSpot.Domain.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<CompanyRequestModel> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<CompanyRequestModel>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<CompanyRequestModel>
                {
                    Name = "Default Code Generated Scenario",
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<CompanyRequestModel>();

                        var result = new SystemUnderTestExpectedStringRepresentation<CompanyRequestModel>
                        {
                            SystemUnderTest = systemUnderTest,
                            ExpectedStringRepresentation = Invariant($"Naos.HubSpot.Domain.CompanyRequestModel: Id = {systemUnderTest.Id?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}, Properties = {systemUnderTest.Properties?.ToString() ?? "<null>"}."),
                        };
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<CompanyRequestModel> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<CompanyRequestModel>()
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<CompanyRequestModel>
                {
                    Name = "constructor should throw ArgumentNullException when parameter 'id' is null scenario",
                    ConstructionFunc = () =>
                    {
                        var referenceObject = A.Dummy<CompanyRequestModel>();
        ...
        private static readonly ConstructorPropertyAssignmentTestScenarios<CompanyRequestModel> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<CompanyRequestModel>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<CompanyRequestModel>
                {
                    ...
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        ...
                        var result = new SystemUnderTestExpectedPropertyValue<CompanyRequestModel>
                        {
                            SystemUnderTest = new CompanyRequestModel(
                                                      referenceObject.Id,
                                                      referenceObject.Properties),
        ...
        private static readonly DeepCloneWithTestScenarios<CompanyRequestModel> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<CompanyRequestModel>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<CompanyRequestModel>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<CompanyRequestModel>().ThatIs(_ => !systemUnderTest.Id.IsEqualTo(_.Id));

                        var result = new SystemUnderTestDeepCloneWithValue<CompanyRequestModel>
                        {
                            SystemUnderTest = systemUnderTest,
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<CompanyRequestModel>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<CompanyRequestModel>().ThatIs(_ => !systemUnderTest.Properties.IsEqualTo(_.Properties));
        ...
        private static readonly CompanyRequestModel ReferenceObjectForEquatableTestScenarios = A.Dummy<CompanyRequestModel>();

        private static readonly EquatableTestScenarios<CompanyRequestModel> EquatableTestScenarios = new EquatableTestScenarios<CompanyRequestModel>()
            .AddScenario(() =>
                new EquatableTestScenario<CompanyRequestModel>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new CompanyRequestModel[]
                    {
                        new CompanyRequestModel(
                                ReferenceObjectForEquatableTestScenarios.Id,
                                ReferenceObjectForEquatableTestScenarios.Properties),
                    },
                    ObjectsThatAreNotEqualToReferenceObject = new CompanyRequestModel[]
                    {
                        new CompanyRequestModel(
                                A.Dummy<CompanyRequestModel>().Whose(_ => !_.Id.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Id)).Id,
                                ReferenceObjectForEquatableTestScenarios.Properties),
                        new CompanyRequestModel(
                                ReferenceObjectForEquatableTestScenarios.Id,
                                A.Dummy<CompanyRequestModel>().Whose(_ => !_.Properties.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Properties)).Properties),
                    },
        ...
        public static class Structural
        {
            ...
            {
                // Arrange
                var type = typeof(CompanyRequestModel);

                var expectedModelMethods = typeof(IModel<CompanyRequestModel>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<CompanyRequestModel>));
        ...
        public static class Cloning
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (CompanyRequestModel)systemUnderTest.Clone();
            ...
            public static void DeepCloneWith___Should_deep_clone_object_and_replace_the_associated_property_with_the_provided_value___When_called()
            {
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (CompanyRequestModel)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach(var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(CompanyRequestModel).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class Serialization
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<CompanyRequestModel>();
        ...
        public static class Equality
        {
            ...
            {
                // Arrange
                CompanyRequestModel systemUnderTest1 = null;
                CompanyRequestModel systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    CompanyRequestModel systemUnderTest = null;
