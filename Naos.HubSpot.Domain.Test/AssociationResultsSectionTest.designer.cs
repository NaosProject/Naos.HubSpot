...
namespace Naos.HubSpot.Domain.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<AssociationResultsSection> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<AssociationResultsSection>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<AssociationResultsSection>
                {
                    Name = "Default Code Generated Scenario",
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<AssociationResultsSection>();

                        var result = new SystemUnderTestExpectedStringRepresentation<AssociationResultsSection>
                        {
                            SystemUnderTest = systemUnderTest,
                            ExpectedStringRepresentation = Invariant($"Naos.HubSpot.Domain.AssociationResultsSection: Id = {systemUnderTest.Id?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}, Type = {systemUnderTest.Type?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}."),
                        };
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<AssociationResultsSection> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<AssociationResultsSection>()
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<AssociationResultsSection>
                {
                    Name = "constructor should throw ArgumentNullException when parameter 'id' is null scenario",
                    ConstructionFunc = () =>
                    {
                        var referenceObject = A.Dummy<AssociationResultsSection>();

                        var result = new AssociationResultsSection(
                                             null,
        ...
        private static readonly ConstructorPropertyAssignmentTestScenarios<AssociationResultsSection> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<AssociationResultsSection>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<AssociationResultsSection>
                {
                    ...
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        ...
                        var result = new SystemUnderTestExpectedPropertyValue<AssociationResultsSection>
                        {
                            SystemUnderTest = new AssociationResultsSection(
                                                      referenceObject.Id,
                                                      referenceObject.Type),
        ...
        private static readonly DeepCloneWithTestScenarios<AssociationResultsSection> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<AssociationResultsSection>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<AssociationResultsSection>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<AssociationResultsSection>().ThatIs(_ => !systemUnderTest.Id.IsEqualTo(_.Id));

                        var result = new SystemUnderTestDeepCloneWithValue<AssociationResultsSection>
                        {
                            SystemUnderTest = systemUnderTest,
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<AssociationResultsSection>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<AssociationResultsSection>().ThatIs(_ => !systemUnderTest.Type.IsEqualTo(_.Type));
        ...
        private static readonly AssociationResultsSection ReferenceObjectForEquatableTestScenarios = A.Dummy<AssociationResultsSection>();

        private static readonly EquatableTestScenarios<AssociationResultsSection> EquatableTestScenarios = new EquatableTestScenarios<AssociationResultsSection>()
            .AddScenario(() =>
                new EquatableTestScenario<AssociationResultsSection>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new AssociationResultsSection[]
                    {
                        new AssociationResultsSection(
                                ReferenceObjectForEquatableTestScenarios.Id,
                                ReferenceObjectForEquatableTestScenarios.Type),
                    },
                    ObjectsThatAreNotEqualToReferenceObject = new AssociationResultsSection[]
                    {
                        new AssociationResultsSection(
                                A.Dummy<AssociationResultsSection>().Whose(_ => !_.Id.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Id)).Id,
                                ReferenceObjectForEquatableTestScenarios.Type),
                        new AssociationResultsSection(
                                ReferenceObjectForEquatableTestScenarios.Id,
                                A.Dummy<AssociationResultsSection>().Whose(_ => !_.Type.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Type)).Type),
                    },
        ...
        public static class Structural
        {
            ...
            public static void AssociationResultsSection___Should_implement_IModel_of_AssociationResultsSection___When_reflecting()
            {
                // Arrange
                var type = typeof(AssociationResultsSection);

                var expectedModelMethods = typeof(IModel<AssociationResultsSection>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<AssociationResultsSection>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void AssociationResultsSection___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(AssociationResultsSection);
        ...
        public static class Cloning
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (AssociationResultsSection)systemUnderTest.Clone();
            ...
            {
                var propertyNames = new string[] { "Id", "Type" };
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (AssociationResultsSection)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach(var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(AssociationResultsSection).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class Serialization
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<AssociationResultsSection>();
        ...
        public static class Equality
        {
            ...
            {
                // Arrange
                AssociationResultsSection systemUnderTest1 = null;
                AssociationResultsSection systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    AssociationResultsSection systemUnderTest = null;
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_AssociationResultsSection___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_AssociationResultsSection___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_AssociationResultsSection___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_AssociationResultsSection___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_AssociationResultsSection___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
