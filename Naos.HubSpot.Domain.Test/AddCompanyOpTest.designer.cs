...
namespace Naos.HubSpot.Domain.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<AddCompanyOp> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<AddCompanyOp>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<AddCompanyOp>
                {
                    Name = "Default Code Generated Scenario",
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<AddCompanyOp>();

                        var result = new SystemUnderTestExpectedStringRepresentation<AddCompanyOp>
                        {
                            SystemUnderTest = systemUnderTest,
                            ExpectedStringRepresentation = Invariant($"Naos.HubSpot.Domain.AddCompanyOp: CompanyToAdd = {systemUnderTest.CompanyToAdd?.ToString() ?? "<null>"}."),
                        };
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<AddCompanyOp> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<AddCompanyOp>()
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<AddCompanyOp>
                {
                    Name = "constructor should throw ArgumentNullException when parameter 'companyToAdd' is null scenario",
                    ConstructionFunc = () =>
                    {
                        var result = new AddCompanyOp(
                                             null);

                        return result;
                    },
                    ExpectedExceptionType = typeof(ArgumentNullException),
                    ExpectedExceptionMessageContains = new[] { "companyToAdd" },
                });

        private static readonly ConstructorPropertyAssignmentTestScenarios<AddCompanyOp> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<AddCompanyOp>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<AddCompanyOp>
                {
                    Name = "CompanyToAdd should return same 'companyToAdd' parameter passed to constructor when getting",
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        var referenceObject = A.Dummy<AddCompanyOp>();

                        var result = new SystemUnderTestExpectedPropertyValue<AddCompanyOp>
                        {
                            SystemUnderTest = new AddCompanyOp(
                                                      referenceObject.CompanyToAdd),
                            ExpectedPropertyValue = referenceObject.CompanyToAdd,
                        };

                        return result;
                    },
                    PropertyName = "CompanyToAdd",
                });

        private static readonly DeepCloneWithTestScenarios<AddCompanyOp> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<AddCompanyOp>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<AddCompanyOp>
                {
                    Name = "DeepCloneWithCompanyToAdd should deep clone object and replace CompanyToAdd with the provided companyToAdd",
                    WithPropertyName = "CompanyToAdd",
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<AddCompanyOp>();

                        var referenceObject = A.Dummy<AddCompanyOp>().ThatIs(_ => !systemUnderTest.CompanyToAdd.IsEqualTo(_.CompanyToAdd));

                        var result = new SystemUnderTestDeepCloneWithValue<AddCompanyOp>
                        {
                            SystemUnderTest = systemUnderTest,
                            DeepCloneWithValue = referenceObject.CompanyToAdd,
                        };
        ...
        private static readonly AddCompanyOp ReferenceObjectForEquatableTestScenarios = A.Dummy<AddCompanyOp>();

        private static readonly EquatableTestScenarios<AddCompanyOp> EquatableTestScenarios = new EquatableTestScenarios<AddCompanyOp>()
            .AddScenario(() =>
                new EquatableTestScenario<AddCompanyOp>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new AddCompanyOp[]
                    {
                        new AddCompanyOp(
                                ReferenceObjectForEquatableTestScenarios.CompanyToAdd),
                    },
                    ObjectsThatAreNotEqualToReferenceObject = new AddCompanyOp[]
                    {
                        new AddCompanyOp(
                                A.Dummy<AddCompanyOp>().Whose(_ => !_.CompanyToAdd.IsEqualTo(ReferenceObjectForEquatableTestScenarios.CompanyToAdd)).CompanyToAdd),
                    },
        ...
        public static class Structural
        {
            ...
            public static void AddCompanyOp___Should_implement_IModel_of_AddCompanyOp___When_reflecting()
            {
                // Arrange
                var type = typeof(AddCompanyOp);

                var expectedModelMethods = typeof(IModel<AddCompanyOp>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<AddCompanyOp>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void AddCompanyOp___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(AddCompanyOp);
        ...
        public static class Cloning
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (AddCompanyOp)systemUnderTest.Clone();
            ...
            public static void DeepClone___Should_deep_clone_object___When_called()
            {
                ...
                if (systemUnderTest.CompanyToAdd == null)
                {
                    actual.CompanyToAdd.AsTest().Must().BeNull();
                }
                else
                {
                    actual.CompanyToAdd.AsTest().Must().NotBeSameReferenceAs(systemUnderTest.CompanyToAdd);
                }
            }
            ...
            {
                var propertyNames = new string[] { "CompanyToAdd" };
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (AddCompanyOp)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach(var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(AddCompanyOp).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class Serialization
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<AddCompanyOp>();
        ...
        public static class Equality
        {
            ...
            {
                // Arrange
                AddCompanyOp systemUnderTest1 = null;
                AddCompanyOp systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    AddCompanyOp systemUnderTest = null;
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_AddCompanyOp___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_AddCompanyOp___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_AddCompanyOp___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_AddCompanyOp___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_AddCompanyOp___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
