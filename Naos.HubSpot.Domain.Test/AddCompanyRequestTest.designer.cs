...
namespace Naos.HubSpot.Domain.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<AddCompanyRequest> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<AddCompanyRequest>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<AddCompanyRequest>
                {
                    Name = "Default Code Generated Scenario",
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<AddCompanyRequest>();

                        var result = new SystemUnderTestExpectedStringRepresentation<AddCompanyRequest>
                        {
                            SystemUnderTest = systemUnderTest,
                            ExpectedStringRepresentation = Invariant($"Naos.HubSpot.Domain.AddCompanyRequest: Properties = {systemUnderTest.Properties?.ToString() ?? "<null>"}."),
                        };
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<AddCompanyRequest> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<AddCompanyRequest>()
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<AddCompanyRequest>
                {
            ...
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<AddCompanyRequest>
                {
                    ...
                    ConstructionFunc = () =>
                    {
                        var referenceObject = A.Dummy<AddCompanyRequest>();
        ...
        private static readonly ConstructorPropertyAssignmentTestScenarios<AddCompanyRequest> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<AddCompanyRequest>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<AddCompanyRequest>
                {
                    ...
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        ...
                        var result = new SystemUnderTestExpectedPropertyValue<AddCompanyRequest>
                        {
                            SystemUnderTest = new AddCompanyRequest(
        ...
        private static readonly DeepCloneWithTestScenarios<AddCompanyRequest> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<AddCompanyRequest>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<AddCompanyRequest>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<AddCompanyRequest>().ThatIs(_ => !systemUnderTest.Properties.IsEqualTo(_.Properties));

                        var result = new SystemUnderTestDeepCloneWithValue<AddCompanyRequest>
                        {
                            SystemUnderTest = systemUnderTest,
        ...
        private static readonly AddCompanyRequest ReferenceObjectForEquatableTestScenarios = A.Dummy<AddCompanyRequest>();

        private static readonly EquatableTestScenarios<AddCompanyRequest> EquatableTestScenarios = new EquatableTestScenarios<AddCompanyRequest>()
            .AddScenario(() =>
                new EquatableTestScenario<AddCompanyRequest>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new AddCompanyRequest[]
                    {
                        new AddCompanyRequest(
                                ReferenceObjectForEquatableTestScenarios.Properties),
                    },
                    ObjectsThatAreNotEqualToReferenceObject = new AddCompanyRequest[]
                    {
                        new AddCompanyRequest(
                                A.Dummy<AddCompanyRequest>().Whose(_ => !_.Properties.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Properties)).Properties),
                    },
        ...
        public static class Structural
        {
            ...
            public static void AddCompanyRequest___Should_implement_IModel_of_AddCompanyRequest___When_reflecting()
            {
                // Arrange
                var type = typeof(AddCompanyRequest);

                var expectedModelMethods = typeof(IModel<AddCompanyRequest>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<AddCompanyRequest>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void AddCompanyRequest___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(AddCompanyRequest);
        ...
        public static class Cloning
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (AddCompanyRequest)systemUnderTest.Clone();
            ...
            public static void DeepCloneWith___Should_deep_clone_object_and_replace_the_associated_property_with_the_provided_value___When_called()
            {
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (AddCompanyRequest)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach(var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(AddCompanyRequest).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class Serialization
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<AddCompanyRequest>();
        ...
        public static class Equality
        {
            ...
            {
                // Arrange
                AddCompanyRequest systemUnderTest1 = null;
                AddCompanyRequest systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    AddCompanyRequest systemUnderTest = null;
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_AddCompanyRequest___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_AddCompanyRequest___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_AddCompanyRequest___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_AddCompanyRequest___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_AddCompanyRequest___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
