...
namespace Naos.HubSpot.Domain.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<ContactRequestModel> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<ContactRequestModel>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<ContactRequestModel>
                {
                    Name = "Default Code Generated Scenario",
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<ContactRequestModel>();

                        var result = new SystemUnderTestExpectedStringRepresentation<ContactRequestModel>
                        {
                            SystemUnderTest = systemUnderTest,
                            ExpectedStringRepresentation = Invariant($"Naos.HubSpot.Domain.ContactRequestModel: Id = {systemUnderTest.Id?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}, Properties = {systemUnderTest.Properties?.ToString() ?? "<null>"}."),
                        };
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<ContactRequestModel> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<ContactRequestModel>()
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<ContactRequestModel>
                {
                    Name = "constructor should throw ArgumentNullException when parameter 'id' is null scenario",
                    ConstructionFunc = () =>
                    {
                        var referenceObject = A.Dummy<ContactRequestModel>();
        ...
        private static readonly ConstructorPropertyAssignmentTestScenarios<ContactRequestModel> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<ContactRequestModel>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<ContactRequestModel>
                {
                    ...
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        ...
                        var result = new SystemUnderTestExpectedPropertyValue<ContactRequestModel>
                        {
                            SystemUnderTest = new ContactRequestModel(
                                                      referenceObject.Id,
                                                      referenceObject.Properties),
        ...
        private static readonly DeepCloneWithTestScenarios<ContactRequestModel> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<ContactRequestModel>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<ContactRequestModel>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<ContactRequestModel>().ThatIs(_ => !systemUnderTest.Id.IsEqualTo(_.Id));

                        var result = new SystemUnderTestDeepCloneWithValue<ContactRequestModel>
                        {
                            SystemUnderTest = systemUnderTest,
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<ContactRequestModel>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<ContactRequestModel>().ThatIs(_ => !systemUnderTest.Properties.IsEqualTo(_.Properties));
        ...
        private static readonly ContactRequestModel ReferenceObjectForEquatableTestScenarios = A.Dummy<ContactRequestModel>();

        private static readonly EquatableTestScenarios<ContactRequestModel> EquatableTestScenarios = new EquatableTestScenarios<ContactRequestModel>()
            .AddScenario(() =>
                new EquatableTestScenario<ContactRequestModel>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new ContactRequestModel[]
                    {
                        new ContactRequestModel(
                                ReferenceObjectForEquatableTestScenarios.Id,
                                ReferenceObjectForEquatableTestScenarios.Properties),
                    },
                    ObjectsThatAreNotEqualToReferenceObject = new ContactRequestModel[]
                    {
                        new ContactRequestModel(
                                A.Dummy<ContactRequestModel>().Whose(_ => !_.Id.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Id)).Id,
                                ReferenceObjectForEquatableTestScenarios.Properties),
                        new ContactRequestModel(
                                ReferenceObjectForEquatableTestScenarios.Id,
                                A.Dummy<ContactRequestModel>().Whose(_ => !_.Properties.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Properties)).Properties),
                    },
        ...
        public static class Structural
        {
            ...
            public static void ContactRequestModel___Should_implement_IModel_of_ContactRequestModel___When_reflecting()
            {
                ...
                var expectedModelMethods = typeof(IModel<ContactRequestModel>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<ContactRequestModel>));
        ...
        public static class Cloning
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (ContactRequestModel)systemUnderTest.Clone();
            ...
            public static void DeepCloneWith___Should_deep_clone_object_and_replace_the_associated_property_with_the_provided_value___When_called()
            {
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (ContactRequestModel)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach(var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(ContactRequestModel).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class Serialization
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<ContactRequestModel>();
        ...
        public static class Equality
        {
            ...
            {
                // Arrange
                ContactRequestModel systemUnderTest1 = null;
                ContactRequestModel systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    ContactRequestModel systemUnderTest = null;
