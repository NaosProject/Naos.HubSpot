...
namespace Naos.HubSpot.Domain.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<UpdateContactOp> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<UpdateContactOp>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<UpdateContactOp>
                {
                    Name = "Default Code Generated Scenario",
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<UpdateContactOp>();

                        var result = new SystemUnderTestExpectedStringRepresentation<UpdateContactOp>
                        {
                            SystemUnderTest = systemUnderTest,
                            ExpectedStringRepresentation = Invariant($"Naos.HubSpot.Domain.UpdateContactOp: ContactToUpdate = {systemUnderTest.ContactToUpdate?.ToString() ?? "<null>"}."),
                        };
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<UpdateContactOp> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<UpdateContactOp>()
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<UpdateContactOp>
                {
        ...
        private static readonly ConstructorPropertyAssignmentTestScenarios<UpdateContactOp> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<UpdateContactOp>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<UpdateContactOp>
                {
                    Name = "ContactToUpdate should return same 'contactToUpdate' parameter passed to constructor when getting",
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        var referenceObject = A.Dummy<UpdateContactOp>();

                        var result = new SystemUnderTestExpectedPropertyValue<UpdateContactOp>
                        {
                            SystemUnderTest = new UpdateContactOp(
        ...
        private static readonly DeepCloneWithTestScenarios<UpdateContactOp> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<UpdateContactOp>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<UpdateContactOp>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<UpdateContactOp>().ThatIs(_ => !systemUnderTest.ContactToUpdate.IsEqualTo(_.ContactToUpdate));

                        var result = new SystemUnderTestDeepCloneWithValue<UpdateContactOp>
                        {
                            SystemUnderTest = systemUnderTest,
        ...
        private static readonly UpdateContactOp ReferenceObjectForEquatableTestScenarios = A.Dummy<UpdateContactOp>();

        private static readonly EquatableTestScenarios<UpdateContactOp> EquatableTestScenarios = new EquatableTestScenarios<UpdateContactOp>()
            .AddScenario(() =>
                new EquatableTestScenario<UpdateContactOp>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new UpdateContactOp[]
                    {
                        new UpdateContactOp(
                                ReferenceObjectForEquatableTestScenarios.ContactToUpdate),
                    },
                    ObjectsThatAreNotEqualToReferenceObject = new UpdateContactOp[]
                    {
                        new UpdateContactOp(
                                A.Dummy<UpdateContactOp>().Whose(_ => !_.ContactToUpdate.IsEqualTo(ReferenceObjectForEquatableTestScenarios.ContactToUpdate)).ContactToUpdate),
                    },
        ...
        public static class Structural
        {
            ...
            {
                // Arrange
                var type = typeof(UpdateContactOp);

                var expectedModelMethods = typeof(IModel<UpdateContactOp>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<UpdateContactOp>));
        ...
        public static class Cloning
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (UpdateContactOp)systemUnderTest.Clone();
            ...
            public static void DeepCloneWith___Should_deep_clone_object_and_replace_the_associated_property_with_the_provided_value___When_called()
            {
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (UpdateContactOp)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach(var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(UpdateContactOp).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class Serialization
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<UpdateContactOp>();
        ...
        public static class Equality
        {
            ...
            {
                // Arrange
                UpdateContactOp systemUnderTest1 = null;
                UpdateContactOp systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    UpdateContactOp systemUnderTest = null;
