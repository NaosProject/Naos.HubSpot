...
namespace Naos.HubSpot.Domain.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<DeleteCompanyOp> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<DeleteCompanyOp>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<DeleteCompanyOp>
                {
                    Name = "Default Code Generated Scenario",
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<DeleteCompanyOp>();

                        var result = new SystemUnderTestExpectedStringRepresentation<DeleteCompanyOp>
                        {
                            SystemUnderTest = systemUnderTest,
                            ExpectedStringRepresentation = Invariant($"Naos.HubSpot.Domain.DeleteCompanyOp: CompanyId = {systemUnderTest.CompanyId.ToString(CultureInfo.InvariantCulture) ?? "<null>"}."),
                        };
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<DeleteCompanyOp> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<DeleteCompanyOp>();

        private static readonly ConstructorPropertyAssignmentTestScenarios<DeleteCompanyOp> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<DeleteCompanyOp>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<DeleteCompanyOp>
                {
                    Name = "CompanyId should return same 'companyId' parameter passed to constructor when getting",
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        var referenceObject = A.Dummy<DeleteCompanyOp>();

                        var result = new SystemUnderTestExpectedPropertyValue<DeleteCompanyOp>
                        {
                            SystemUnderTest = new DeleteCompanyOp(
        ...
        private static readonly DeepCloneWithTestScenarios<DeleteCompanyOp> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<DeleteCompanyOp>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<DeleteCompanyOp>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<DeleteCompanyOp>().ThatIs(_ => !systemUnderTest.CompanyId.IsEqualTo(_.CompanyId));

                        var result = new SystemUnderTestDeepCloneWithValue<DeleteCompanyOp>
                        {
                            SystemUnderTest = systemUnderTest,
        ...
        private static readonly DeleteCompanyOp ReferenceObjectForEquatableTestScenarios = A.Dummy<DeleteCompanyOp>();

        private static readonly EquatableTestScenarios<DeleteCompanyOp> EquatableTestScenarios = new EquatableTestScenarios<DeleteCompanyOp>()
            .AddScenario(() =>
                new EquatableTestScenario<DeleteCompanyOp>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new DeleteCompanyOp[]
                    {
                        new DeleteCompanyOp(
                                ReferenceObjectForEquatableTestScenarios.CompanyId),
                    },
                    ObjectsThatAreNotEqualToReferenceObject = new DeleteCompanyOp[]
                    {
                        new DeleteCompanyOp(
                                A.Dummy<DeleteCompanyOp>().Whose(_ => !_.CompanyId.IsEqualTo(ReferenceObjectForEquatableTestScenarios.CompanyId)).CompanyId),
                    },
        ...
        public static class Structural
        {
            ...
            public static void DeleteCompanyOp___Should_implement_IModel_of_DeleteCompanyOp___When_reflecting()
            {
                // Arrange
                var type = typeof(DeleteCompanyOp);

                var expectedModelMethods = typeof(IModel<DeleteCompanyOp>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<DeleteCompanyOp>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void DeleteCompanyOp___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(DeleteCompanyOp);
        ...
        public static class Cloning
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (DeleteCompanyOp)systemUnderTest.Clone();
            ...
            {
                var propertyNames = new string[] { "CompanyId" };
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (DeleteCompanyOp)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach(var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(DeleteCompanyOp).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class Serialization
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<DeleteCompanyOp>();
        ...
        public static class Equality
        {
            ...
            {
                // Arrange
                DeleteCompanyOp systemUnderTest1 = null;
                DeleteCompanyOp systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    DeleteCompanyOp systemUnderTest = null;
            ...
            public static void Equals_with_ReturningOperationBase___Should_return_false___When_parameter_other_is_null()
            {
                ...
                {
                    // Arrange
                    ReturningOperationBase<DeleteCompanyResponse> systemUnderTest = null;

                    // Act
                    var actual = scenario.ReferenceObject.Equals((ReturningOperationBase<DeleteCompanyResponse>)systemUnderTest);
            ...
            public static void Equals_with_ReturningOperationBase___Should_return_true___When_parameter_other_is_same_object()
            {
                ...
                {
                    // Arrange, Act
                    var actual = scenario.ReferenceObject.Equals((ReturningOperationBase<DeleteCompanyResponse>)scenario.ReferenceObject);
            ...
            public static void Equals_with_ReturningOperationBase___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                ...
                {
                    // Arrange, Act
                    var actuals = scenario.ObjectsThatDeriveFromScenarioTypeButAreNotOfTheSameTypeAsReferenceObject.Select(_ => scenario.ReferenceObject.Equals((ReturningOperationBase<DeleteCompanyResponse>)_)).ToList();
            ...
            public static void Equals_with_ReturningOperationBase___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                ...
                {
                    // Arrange, Act
                    var actuals = scenario.ObjectsThatAreNotEqualToReferenceObject.Select(_ => scenario.ReferenceObject.Equals((ReturningOperationBase<DeleteCompanyResponse>)_)).ToList();
            ...
            public static void Equals_with_ReturningOperationBase___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                ...
                {
                    // Arrange, Act
                    var actuals = scenario.ObjectsThatAreEqualToButNotTheSameAsReferenceObject.Select(_ => scenario.ReferenceObject.Equals((ReturningOperationBase<DeleteCompanyResponse>)_)).ToList();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_DeleteCompanyOp___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_DeleteCompanyOp___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_DeleteCompanyOp___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_DeleteCompanyOp___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_DeleteCompanyOp___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
