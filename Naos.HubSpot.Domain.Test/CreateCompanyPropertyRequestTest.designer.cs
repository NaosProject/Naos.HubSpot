    ...
    public static partial class CreateCompanyPropertyRequestTest
    {
        ...
        public static class Structural
        {
            ...
            public static void CreateCompanyPropertyRequest___Should_implement_IModel_of_CreateCompanyPropertyRequest___When_reflecting()
            {
                ...
                var expectedModelMethods = typeof(IModel<CreateCompanyPropertyRequest>).GetInterfaceDeclaredAndImplementedMethods();
        ...
        public static class Cloning
        {
            ...
            public static void DeepCloneWith___Should_deep_clone_object_and_replace_the_associated_property_with_the_provided_value___When_called()
            {
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    {
                        var propertyInfo = typeof(CreateCompanyPropertyRequest).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
