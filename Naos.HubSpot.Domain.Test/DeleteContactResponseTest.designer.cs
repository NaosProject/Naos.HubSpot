...
namespace Naos.HubSpot.Domain.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<DeleteContactResponse> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<DeleteContactResponse>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<DeleteContactResponse>
                {
                    Name = "Default Code Generated Scenario",
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<DeleteContactResponse>();
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<DeleteContactResponse> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<DeleteContactResponse>()
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<DeleteContactResponse>
                {
                    Name = "constructor should throw ArgumentNullException when parameter 'reason' is null scenario",
                    ConstructionFunc = () =>
                    {
                        var referenceObject = A.Dummy<DeleteContactResponse>();
        ...
        private static readonly ConstructorPropertyAssignmentTestScenarios<DeleteContactResponse> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<DeleteContactResponse>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<DeleteContactResponse>
                {
                    ...
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        ...
                        var result = new SystemUnderTestExpectedPropertyValue<DeleteContactResponse>
                        {
                            SystemUnderTest = new DeleteContactResponse(
                                                      referenceObject.Vid,
                                                      referenceObject.Deleted,
        ...
        private static readonly DeepCloneWithTestScenarios<DeleteContactResponse> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<DeleteContactResponse>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<DeleteContactResponse>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<DeleteContactResponse>().ThatIs(_ => !systemUnderTest.Vid.IsEqualTo(_.Vid));

                        var result = new SystemUnderTestDeepCloneWithValue<DeleteContactResponse>
                        {
                            SystemUnderTest = systemUnderTest,
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<DeleteContactResponse>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<DeleteContactResponse>().ThatIs(_ => !systemUnderTest.Deleted.IsEqualTo(_.Deleted));
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<DeleteContactResponse>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<DeleteContactResponse>().ThatIs(_ => !systemUnderTest.Reason.IsEqualTo(_.Reason));
        ...
        private static readonly DeleteContactResponse ReferenceObjectForEquatableTestScenarios = A.Dummy<DeleteContactResponse>();

        private static readonly EquatableTestScenarios<DeleteContactResponse> EquatableTestScenarios = new EquatableTestScenarios<DeleteContactResponse>()
            .AddScenario(() =>
                new EquatableTestScenario<DeleteContactResponse>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new DeleteContactResponse[]
                    {
                    ...
                    ObjectsThatAreNotEqualToReferenceObject = new DeleteContactResponse[]
                    {
                        new DeleteContactResponse(
                                A.Dummy<DeleteContactResponse>().Whose(_ => !_.Vid.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Vid)).Vid,
                                ReferenceObjectForEquatableTestScenarios.Deleted,
                                ReferenceObjectForEquatableTestScenarios.Reason),
                        new DeleteContactResponse(
                                ReferenceObjectForEquatableTestScenarios.Vid,
                                A.Dummy<DeleteContactResponse>().Whose(_ => !_.Deleted.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Deleted)).Deleted,
                                ReferenceObjectForEquatableTestScenarios.Reason),
                        new DeleteContactResponse(
                                ReferenceObjectForEquatableTestScenarios.Vid,
                                ReferenceObjectForEquatableTestScenarios.Deleted,
                                A.Dummy<DeleteContactResponse>().Whose(_ => !_.Reason.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Reason)).Reason),
                    },
        ...
        public static class Structural
        {
            ...
            public static void DeleteContactResponse___Should_implement_IModel_of_DeleteContactResponse___When_reflecting()
            {
                // Arrange
                var type = typeof(DeleteContactResponse);

                var expectedModelMethods = typeof(IModel<DeleteContactResponse>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<DeleteContactResponse>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void DeleteContactResponse___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(DeleteContactResponse);
        ...
        public static class Cloning
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (DeleteContactResponse)systemUnderTest.Clone();
            ...
            {
                var propertyNames = new string[] { "Vid", "Deleted", "Reason" };
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (DeleteContactResponse)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach(var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(DeleteContactResponse).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class Serialization
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<DeleteContactResponse>();
        ...
        public static class Equality
        {
            ...
            {
                // Arrange
                DeleteContactResponse systemUnderTest1 = null;
                DeleteContactResponse systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    DeleteContactResponse systemUnderTest = null;
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_DeleteContactResponse___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_DeleteContactResponse___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_DeleteContactResponse___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_DeleteContactResponse___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_DeleteContactResponse___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
