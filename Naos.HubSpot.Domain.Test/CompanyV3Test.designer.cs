...
namespace Naos.HubSpot.Domain.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<CompanyV3> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<CompanyV3>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<CompanyV3>
                {
                    Name = "Default Code Generated Scenario",
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<CompanyV3>();

                        var result = new SystemUnderTestExpectedStringRepresentation<CompanyV3>
                        {
                            SystemUnderTest = systemUnderTest,
                            ExpectedStringRepresentation = Invariant($"Naos.HubSpot.Domain.CompanyV3: Properties = {systemUnderTest.Properties?.ToString() ?? "<null>"}."),
                        };
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<CompanyV3> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<CompanyV3>()
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<CompanyV3>
                {
                    Name = "constructor should throw ArgumentNullException when parameter 'properties' is null scenario",
                    ConstructionFunc = () =>
                    {
                        var result = new CompanyV3(
                                             null);
            ...
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<CompanyV3>
                {
                    ...
                    ConstructionFunc = () =>
                    {
                        var referenceObject = A.Dummy<CompanyV3>();
        ...
        private static readonly ConstructorPropertyAssignmentTestScenarios<CompanyV3> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<CompanyV3>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<CompanyV3>
                {
                    ...
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        ...
                        var result = new SystemUnderTestExpectedPropertyValue<CompanyV3>
                        {
                            SystemUnderTest = new CompanyV3(
        ...
        private static readonly DeepCloneWithTestScenarios<CompanyV3> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<CompanyV3>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<CompanyV3>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<CompanyV3>().ThatIs(_ => !systemUnderTest.Properties.IsEqualTo(_.Properties));

                        var result = new SystemUnderTestDeepCloneWithValue<CompanyV3>
                        {
                            SystemUnderTest = systemUnderTest,
        ...
        private static readonly CompanyV3 ReferenceObjectForEquatableTestScenarios = A.Dummy<CompanyV3>();

        private static readonly EquatableTestScenarios<CompanyV3> EquatableTestScenarios = new EquatableTestScenarios<CompanyV3>()
            .AddScenario(() =>
                new EquatableTestScenario<CompanyV3>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new CompanyV3[]
                    {
                        new CompanyV3(
                                ReferenceObjectForEquatableTestScenarios.Properties),
                    },
                    ObjectsThatAreNotEqualToReferenceObject = new CompanyV3[]
                    {
                        new CompanyV3(
                                A.Dummy<CompanyV3>().Whose(_ => !_.Properties.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Properties)).Properties),
                    },
        ...
        public static class Structural
        {
            ...
            public static void CompanyV3___Should_implement_IModel_of_CompanyV3___When_reflecting()
            {
                // Arrange
                var type = typeof(CompanyV3);

                var expectedModelMethods = typeof(IModel<CompanyV3>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<CompanyV3>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void CompanyV3___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(CompanyV3);
        ...
        public static class Cloning
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (CompanyV3)systemUnderTest.Clone();
            ...
            public static void DeepCloneWith___Should_deep_clone_object_and_replace_the_associated_property_with_the_provided_value___When_called()
            {
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (CompanyV3)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach(var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(CompanyV3).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class Serialization
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<CompanyV3>();
        ...
        public static class Equality
        {
            ...
            {
                // Arrange
                CompanyV3 systemUnderTest1 = null;
                CompanyV3 systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    CompanyV3 systemUnderTest = null;
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_CompanyV3___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_CompanyV3___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_CompanyV3___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_CompanyV3___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_CompanyV3___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
