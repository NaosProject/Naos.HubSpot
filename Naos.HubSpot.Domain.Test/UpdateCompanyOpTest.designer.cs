    ...
    public static partial class UpdateCompanyOpTest
    {
                ...
                new StringRepresentationTestScenario<UpdateCompanyOp>
                {
                    ...
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        ...
                        var result = new SystemUnderTestExpectedStringRepresentation<UpdateCompanyOp>
                        {
                            ...
                            ExpectedStringRepresentation = Invariant($"Naos.HubSpot.Domain.UpdateCompanyOp: CompanyToUpdate = {systemUnderTest.CompanyToUpdate?.ToString() ?? "<null>"}."),
                        };
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<UpdateCompanyOp>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<UpdateCompanyOp>().ThatIs(_ => !systemUnderTest.CompanyToUpdate.IsEqualTo(_.CompanyToUpdate));
        ...
        private static readonly EquatableTestScenarios<UpdateCompanyOp> EquatableTestScenarios = new EquatableTestScenarios<UpdateCompanyOp>()
            .AddScenario(() =>
                new EquatableTestScenario<UpdateCompanyOp>
                {
                    ...
                    {
                        new UpdateCompanyOp(
                                A.Dummy<UpdateCompanyOp>().Whose(_ => !_.CompanyToUpdate.IsEqualTo(ReferenceObjectForEquatableTestScenarios.CompanyToUpdate)).CompanyToUpdate),
                    },
        ...
        public static class Structural
        {
            ...
            public static void UpdateCompanyV3Op___Should_implement_IModel_of_UpdateCompanyV3Op___When_reflecting()
            {
                ...
                var expectedModelMethods = typeof(IModel<UpdateCompanyOp>).GetInterfaceDeclaredAndImplementedMethods();
        ...
        public static class Cloning
        {
            ...
            public static void DeepCloneWith___Should_deep_clone_object_and_replace_the_associated_property_with_the_provided_value___When_called()
            {
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    {
                        var propertyInfo = typeof(UpdateCompanyOp).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
