...
namespace Naos.HubSpot.Domain.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<CreateContactV3Op> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<CreateContactV3Op>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<CreateContactV3Op>
                {
                    Name = "Default Code Generated Scenario",
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<CreateContactV3Op>();

                        var result = new SystemUnderTestExpectedStringRepresentation<CreateContactV3Op>
                        {
                            SystemUnderTest = systemUnderTest,
                            ExpectedStringRepresentation = Invariant($"Naos.HubSpot.Domain.CreateContactV3Op: ContactToCreate = {systemUnderTest.ContactToCreate?.ToString() ?? "<null>"}."),
                        };
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<CreateContactV3Op> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<CreateContactV3Op>()
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<CreateContactV3Op>
                {
                    Name = "constructor should throw ArgumentNullException when parameter 'contactToCreate' is null scenario",
                    ConstructionFunc = () =>
                    {
                    ...
                    ExpectedExceptionMessageContains = new[] { "contactToCreate" },
                });

        private static readonly ConstructorPropertyAssignmentTestScenarios<CreateContactV3Op> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<CreateContactV3Op>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<CreateContactV3Op>
                {
                    Name = "ContactToCreate should return same 'contactToCreate' parameter passed to constructor when getting",
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        var referenceObject = A.Dummy<CreateContactV3Op>();

                        var result = new SystemUnderTestExpectedPropertyValue<CreateContactV3Op>
                        {
                            SystemUnderTest = new CreateContactV3Op(
                                                      referenceObject.ContactToCreate),
                            ExpectedPropertyValue = referenceObject.ContactToCreate,
                        };

                        return result;
                    },
                    PropertyName = "ContactToCreate",
                });

        private static readonly DeepCloneWithTestScenarios<CreateContactV3Op> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<CreateContactV3Op>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<CreateContactV3Op>
                {
                    Name = "DeepCloneWithContactToCreate should deep clone object and replace ContactToCreate with the provided contactToCreate",
                    WithPropertyName = "ContactToCreate",
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<CreateContactV3Op>();

                        var referenceObject = A.Dummy<CreateContactV3Op>().ThatIs(_ => !systemUnderTest.ContactToCreate.IsEqualTo(_.ContactToCreate));

                        var result = new SystemUnderTestDeepCloneWithValue<CreateContactV3Op>
                        {
                            SystemUnderTest = systemUnderTest,
                            DeepCloneWithValue = referenceObject.ContactToCreate,
                        };
        ...
        private static readonly CreateContactV3Op ReferenceObjectForEquatableTestScenarios = A.Dummy<CreateContactV3Op>();

        private static readonly EquatableTestScenarios<CreateContactV3Op> EquatableTestScenarios = new EquatableTestScenarios<CreateContactV3Op>()
            .AddScenario(() =>
                new EquatableTestScenario<CreateContactV3Op>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new CreateContactV3Op[]
                    {
                        new CreateContactV3Op(
                                ReferenceObjectForEquatableTestScenarios.ContactToCreate),
                    },
                    ObjectsThatAreNotEqualToReferenceObject = new CreateContactV3Op[]
                    {
                        new CreateContactV3Op(
                                A.Dummy<CreateContactV3Op>().Whose(_ => !_.ContactToCreate.IsEqualTo(ReferenceObjectForEquatableTestScenarios.ContactToCreate)).ContactToCreate),
                    },
        ...
        public static class Structural
        {
            ...
            public static void CreateContactV3Op___Should_implement_IModel_of_CreateContactV3Op___When_reflecting()
            {
                // Arrange
                var type = typeof(CreateContactV3Op);

                var expectedModelMethods = typeof(IModel<CreateContactV3Op>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<CreateContactV3Op>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void CreateContactV3Op___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(CreateContactV3Op);
        ...
        public static class Cloning
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (CreateContactV3Op)systemUnderTest.Clone();
            ...
            public static void DeepClone___Should_deep_clone_object___When_called()
            {
                ...
                if (systemUnderTest.ContactToCreate == null)
                {
                    actual.ContactToCreate.AsTest().Must().BeNull();
                }
                else
                {
                    actual.ContactToCreate.AsTest().Must().NotBeSameReferenceAs(systemUnderTest.ContactToCreate);
                }
            }
            ...
            {
                var propertyNames = new string[] { "ContactToCreate" };
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (CreateContactV3Op)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach(var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(CreateContactV3Op).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class Serialization
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<CreateContactV3Op>();
        ...
        public static class Equality
        {
            ...
            {
                // Arrange
                CreateContactV3Op systemUnderTest1 = null;
                CreateContactV3Op systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    CreateContactV3Op systemUnderTest = null;
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_CreateContactV3Op___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_CreateContactV3Op___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_CreateContactV3Op___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_CreateContactV3Op___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_CreateContactV3Op___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
