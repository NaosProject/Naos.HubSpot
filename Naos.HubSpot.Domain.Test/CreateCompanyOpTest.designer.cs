...
namespace Naos.HubSpot.Domain.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<CreateCompanyOp> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<CreateCompanyOp>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<CreateCompanyOp>
                {
                    Name = "Default Code Generated Scenario",
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<CreateCompanyOp>();

                        var result = new SystemUnderTestExpectedStringRepresentation<CreateCompanyOp>
                        {
                            SystemUnderTest = systemUnderTest,
                            ExpectedStringRepresentation = Invariant($"Naos.HubSpot.Domain.CreateCompanyOp: CompanyToCreate = {systemUnderTest.CompanyToCreate?.ToString() ?? "<null>"}."),
                        };
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<CreateCompanyOp> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<CreateCompanyOp>()
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<CreateCompanyOp>
                {
                    Name = "constructor should throw ArgumentNullException when parameter 'companyToCreate' is null scenario",
                    ConstructionFunc = () =>
                    {
                        var result = new CreateCompanyOp(
                                             null);
        ...
        private static readonly ConstructorPropertyAssignmentTestScenarios<CreateCompanyOp> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<CreateCompanyOp>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<CreateCompanyOp>
                {
                    Name = "CompanyToCreate should return same 'companyToCreate' parameter passed to constructor when getting",
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        var referenceObject = A.Dummy<CreateCompanyOp>();

                        var result = new SystemUnderTestExpectedPropertyValue<CreateCompanyOp>
                        {
                            SystemUnderTest = new CreateCompanyOp(
        ...
        private static readonly DeepCloneWithTestScenarios<CreateCompanyOp> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<CreateCompanyOp>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<CreateCompanyOp>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<CreateCompanyOp>().ThatIs(_ => !systemUnderTest.CompanyToCreate.IsEqualTo(_.CompanyToCreate));

                        var result = new SystemUnderTestDeepCloneWithValue<CreateCompanyOp>
                        {
                            SystemUnderTest = systemUnderTest,
        ...
        private static readonly CreateCompanyOp ReferenceObjectForEquatableTestScenarios = A.Dummy<CreateCompanyOp>();

        private static readonly EquatableTestScenarios<CreateCompanyOp> EquatableTestScenarios = new EquatableTestScenarios<CreateCompanyOp>()
            .AddScenario(() =>
                new EquatableTestScenario<CreateCompanyOp>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new CreateCompanyOp[]
                    {
                        new CreateCompanyOp(
                                ReferenceObjectForEquatableTestScenarios.CompanyToCreate),
                    },
                    ObjectsThatAreNotEqualToReferenceObject = new CreateCompanyOp[]
                    {
                        new CreateCompanyOp(
                                A.Dummy<CreateCompanyOp>().Whose(_ => !_.CompanyToCreate.IsEqualTo(ReferenceObjectForEquatableTestScenarios.CompanyToCreate)).CompanyToCreate),
                    },
        ...
        public static class Structural
        {
            ...
            {
                // Arrange
                var type = typeof(CreateCompanyOp);

                var expectedModelMethods = typeof(IModel<CreateCompanyOp>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<CreateCompanyOp>));
        ...
        public static class Cloning
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (CreateCompanyOp)systemUnderTest.Clone();
            ...
            public static void DeepCloneWith___Should_deep_clone_object_and_replace_the_associated_property_with_the_provided_value___When_called()
            {
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (CreateCompanyOp)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach(var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(CreateCompanyOp).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class Serialization
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<CreateCompanyOp>();
        ...
        public static class Equality
        {
            ...
            {
                // Arrange
                CreateCompanyOp systemUnderTest1 = null;
                CreateCompanyOp systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    CreateCompanyOp systemUnderTest = null;
