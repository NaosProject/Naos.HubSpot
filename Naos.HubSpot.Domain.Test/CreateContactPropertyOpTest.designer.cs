...
namespace Naos.HubSpot.Domain.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<CreateContactPropertyOp> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<CreateContactPropertyOp>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<CreateContactPropertyOp>
                {
                    Name = "Default Code Generated Scenario",
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<CreateContactPropertyOp>();

                        var result = new SystemUnderTestExpectedStringRepresentation<CreateContactPropertyOp>
                        {
                            SystemUnderTest = systemUnderTest,
                            ExpectedStringRepresentation = Invariant($"Naos.HubSpot.Domain.CreateContactPropertyOp: Request = {systemUnderTest.Request?.ToString() ?? "<null>"}."),
                        };
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<CreateContactPropertyOp> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<CreateContactPropertyOp>()
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<CreateContactPropertyOp>
                {
        ...
        private static readonly ConstructorPropertyAssignmentTestScenarios<CreateContactPropertyOp> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<CreateContactPropertyOp>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<CreateContactPropertyOp>
                {
                    Name = "Request should return same 'request' parameter passed to constructor when getting",
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        var referenceObject = A.Dummy<CreateContactPropertyOp>();

                        var result = new SystemUnderTestExpectedPropertyValue<CreateContactPropertyOp>
                        {
                            SystemUnderTest = new CreateContactPropertyOp(
        ...
        private static readonly DeepCloneWithTestScenarios<CreateContactPropertyOp> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<CreateContactPropertyOp>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<CreateContactPropertyOp>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<CreateContactPropertyOp>().ThatIs(_ => !systemUnderTest.Request.IsEqualTo(_.Request));

                        var result = new SystemUnderTestDeepCloneWithValue<CreateContactPropertyOp>
                        {
                            SystemUnderTest = systemUnderTest,
        ...
        private static readonly CreateContactPropertyOp ReferenceObjectForEquatableTestScenarios = A.Dummy<CreateContactPropertyOp>();

        private static readonly EquatableTestScenarios<CreateContactPropertyOp> EquatableTestScenarios = new EquatableTestScenarios<CreateContactPropertyOp>()
            .AddScenario(() =>
                new EquatableTestScenario<CreateContactPropertyOp>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new CreateContactPropertyOp[]
                    {
                        new CreateContactPropertyOp(
                                ReferenceObjectForEquatableTestScenarios.Request),
                    },
                    ObjectsThatAreNotEqualToReferenceObject = new CreateContactPropertyOp[]
                    {
                        new CreateContactPropertyOp(
                                A.Dummy<CreateContactPropertyOp>().Whose(_ => !_.Request.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Request)).Request),
                    },
        ...
        public static class Structural
        {
            ...
            public static void CreateContactPropertyOp___Should_implement_IModel_of_CreateContactPropertyOp___When_reflecting()
            {
                // Arrange
                var type = typeof(CreateContactPropertyOp);

                var expectedModelMethods = typeof(IModel<CreateContactPropertyOp>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<CreateContactPropertyOp>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void CreateContactPropertyOp___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(CreateContactPropertyOp);
        ...
        public static class Cloning
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (CreateContactPropertyOp)systemUnderTest.Clone();
            ...
            public static void DeepCloneWith___Should_deep_clone_object_and_replace_the_associated_property_with_the_provided_value___When_called()
            {
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (CreateContactPropertyOp)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach(var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(CreateContactPropertyOp).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class Serialization
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<CreateContactPropertyOp>();
        ...
        public static class Equality
        {
            ...
            {
                // Arrange
                CreateContactPropertyOp systemUnderTest1 = null;
                CreateContactPropertyOp systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    CreateContactPropertyOp systemUnderTest = null;
            ...
            public static void Equals_with_ReturningOperationBase___Should_return_false___When_parameter_other_is_null()
            {
                ...
                {
                    // Arrange
                    ReturningOperationBase<ContactPropertyModel> systemUnderTest = null;

                    // Act
                    var actual = scenario.ReferenceObject.Equals((ReturningOperationBase<ContactPropertyModel>)systemUnderTest);
            ...
            public static void Equals_with_ReturningOperationBase___Should_return_true___When_parameter_other_is_same_object()
            {
                ...
                {
                    // Arrange, Act
                    var actual = scenario.ReferenceObject.Equals((ReturningOperationBase<ContactPropertyModel>)scenario.ReferenceObject);
            ...
            public static void Equals_with_ReturningOperationBase___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                ...
                {
                    // Arrange, Act
                    var actuals = scenario.ObjectsThatDeriveFromScenarioTypeButAreNotOfTheSameTypeAsReferenceObject.Select(_ => scenario.ReferenceObject.Equals((ReturningOperationBase<ContactPropertyModel>)_)).ToList();
            ...
            public static void Equals_with_ReturningOperationBase___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                ...
                {
                    // Arrange, Act
                    var actuals = scenario.ObjectsThatAreNotEqualToReferenceObject.Select(_ => scenario.ReferenceObject.Equals((ReturningOperationBase<ContactPropertyModel>)_)).ToList();
            ...
            public static void Equals_with_ReturningOperationBase___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                ...
                {
                    // Arrange, Act
                    var actuals = scenario.ObjectsThatAreEqualToButNotTheSameAsReferenceObject.Select(_ => scenario.ReferenceObject.Equals((ReturningOperationBase<ContactPropertyModel>)_)).ToList();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_CreateContactPropertyOp___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_CreateContactPropertyOp___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_CreateContactPropertyOp___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_CreateContactPropertyOp___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_CreateContactPropertyOp___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
