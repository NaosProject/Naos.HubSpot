    ...
    public static partial class CreatePropertyV3OpTest
    {
                ...
                new StringRepresentationTestScenario<CreatePropertyV3Op>
                {
                    ...
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        ...
                        var result = new SystemUnderTestExpectedStringRepresentation<CreatePropertyV3Op>
                        {
                            ...
                            ExpectedStringRepresentation = Invariant($"Naos.HubSpot.Domain.CreatePropertyV3Op: PropertyToAdd = {systemUnderTest.PropertyToAdd?.ToString() ?? "<null>"}, ObjectType = {systemUnderTest.ObjectType.ToString() ?? "<null>"}."),
                        };
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<CreatePropertyV3Op> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<CreatePropertyV3Op>()
            .AddScenario(() =>
                ...
                {
                    Name = "constructor should throw ArgumentNullException when parameter 'propertyToAdd' is null scenario",
                    ConstructionFunc = () =>
                    {
                    ...
                    ExpectedExceptionMessageContains = new[] { "propertyToAdd" },
                });
        ...
        private static readonly ConstructorPropertyAssignmentTestScenarios<CreatePropertyV3Op> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<CreatePropertyV3Op>()
            .AddScenario(() =>
                ...
                {
                    Name = "PropertyToAdd should return same 'propertyToAdd' parameter passed to constructor when getting",
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        ...
                        var result = new SystemUnderTestExpectedPropertyValue<CreatePropertyV3Op>
                        {
                            SystemUnderTest = new CreatePropertyV3Op(
                                                      referenceObject.PropertyToAdd,
                                                      referenceObject.ObjectType),
                            ExpectedPropertyValue = referenceObject.PropertyToAdd,
                        };
        ...
        private static readonly DeepCloneWithTestScenarios<CreatePropertyV3Op> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<CreatePropertyV3Op>()
            .AddScenario(() =>
                ...
                {
                    Name = "DeepCloneWithPropertyToAdd should deep clone object and replace PropertyToAdd with the provided propertyToAdd",
                    WithPropertyName = "PropertyToAdd",
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<CreatePropertyV3Op>();

                        var referenceObject = A.Dummy<CreatePropertyV3Op>().ThatIs(_ => !systemUnderTest.PropertyToAdd.IsEqualTo(_.PropertyToAdd));

                        var result = new SystemUnderTestDeepCloneWithValue<CreatePropertyV3Op>
                        {
                            SystemUnderTest = systemUnderTest,
                            DeepCloneWithValue = referenceObject.PropertyToAdd,
                        };
                ...
                new EquatableTestScenario<CreatePropertyV3Op>
                {
                    ...
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new CreatePropertyV3Op[]
                    {
                        new CreatePropertyV3Op(
                                ReferenceObjectForEquatableTestScenarios.PropertyToAdd,
                                ReferenceObjectForEquatableTestScenarios.ObjectType),
                    },
                    ObjectsThatAreNotEqualToReferenceObject = new CreatePropertyV3Op[]
                    {
                        new CreatePropertyV3Op(
                                A.Dummy<CreatePropertyV3Op>().Whose(_ => !_.PropertyToAdd.IsEqualTo(ReferenceObjectForEquatableTestScenarios.PropertyToAdd)).PropertyToAdd,
                                ReferenceObjectForEquatableTestScenarios.ObjectType),
                        new CreatePropertyV3Op(
                                ReferenceObjectForEquatableTestScenarios.PropertyToAdd,
        ...
        public static class Cloning
        {
            ...
            public static void DeepClone___Should_deep_clone_object___When_called()
            {
                ...
                if (systemUnderTest.PropertyToAdd == null)
                {
                    actual.PropertyToAdd.AsTest().Must().BeNull();
                }
                else
                {
                    actual.PropertyToAdd.AsTest().Must().NotBeSameReferenceAs(systemUnderTest.PropertyToAdd);
                }
            }
            ...
            {
                var propertyNames = new string[] { "PropertyToAdd", "ObjectType" };
        ...
        public static class Equality
        {
            ...
            public static void Equals_with_ReturningOperationBase___Should_return_false___When_parameter_other_is_null()
            {
                ...
                {
                    // Arrange
                    ReturningOperationBase<PropertyV3> systemUnderTest = null;

                    // Act
                    var actual = scenario.ReferenceObject.Equals((ReturningOperationBase<PropertyV3>)systemUnderTest);
            ...
            public static void Equals_with_ReturningOperationBase___Should_return_true___When_parameter_other_is_same_object()
            {
                ...
                {
                    // Arrange, Act
                    var actual = scenario.ReferenceObject.Equals((ReturningOperationBase<PropertyV3>)scenario.ReferenceObject);
            ...
            public static void Equals_with_ReturningOperationBase___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                ...
                {
                    // Arrange, Act
                    var actuals = scenario.ObjectsThatDeriveFromScenarioTypeButAreNotOfTheSameTypeAsReferenceObject.Select(_ => scenario.ReferenceObject.Equals((ReturningOperationBase<PropertyV3>)_)).ToList();
            ...
            public static void Equals_with_ReturningOperationBase___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                ...
                {
                    // Arrange, Act
                    var actuals = scenario.ObjectsThatAreNotEqualToReferenceObject.Select(_ => scenario.ReferenceObject.Equals((ReturningOperationBase<PropertyV3>)_)).ToList();
            ...
            public static void Equals_with_ReturningOperationBase___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                ...
                {
                    // Arrange, Act
                    var actuals = scenario.ObjectsThatAreEqualToButNotTheSameAsReferenceObject.Select(_ => scenario.ReferenceObject.Equals((ReturningOperationBase<PropertyV3>)_)).ToList();
