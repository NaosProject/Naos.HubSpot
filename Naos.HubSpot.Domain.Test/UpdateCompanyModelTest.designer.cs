...
namespace Naos.HubSpot.Domain.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<UpdateCompanyModel> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<UpdateCompanyModel>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<UpdateCompanyModel>
                {
                    Name = "Default Code Generated Scenario",
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<UpdateCompanyModel>();

                        var result = new SystemUnderTestExpectedStringRepresentation<UpdateCompanyModel>
                        {
                            SystemUnderTest = systemUnderTest,
                            ExpectedStringRepresentation = Invariant($"Naos.HubSpot.Domain.UpdateCompanyModel: ObjectId = {systemUnderTest.ObjectId.ToString(CultureInfo.InvariantCulture) ?? "<null>"}, Properties = {systemUnderTest.Properties?.ToString() ?? "<null>"}."),
                        };
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<UpdateCompanyModel> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<UpdateCompanyModel>()
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<UpdateCompanyModel>
                {
                    Name = "constructor should throw ArgumentNullException when parameter 'properties' is null scenario",
                    ConstructionFunc = () =>
                    {
                        var referenceObject = A.Dummy<UpdateCompanyModel>();
        ...
        private static readonly ConstructorPropertyAssignmentTestScenarios<UpdateCompanyModel> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<UpdateCompanyModel>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<UpdateCompanyModel>
                {
                    Name = "ObjectId should return same 'objectId' parameter passed to constructor when getting",
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        var referenceObject = A.Dummy<UpdateCompanyModel>();

                        var result = new SystemUnderTestExpectedPropertyValue<UpdateCompanyModel>
                        {
                            SystemUnderTest = new UpdateCompanyModel(
                                                      referenceObject.ObjectId,
                                                      referenceObject.Properties),
                            ExpectedPropertyValue = referenceObject.ObjectId,
                        };
        ...
        private static readonly DeepCloneWithTestScenarios<UpdateCompanyModel> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<UpdateCompanyModel>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<UpdateCompanyModel>
                {
                    Name = "DeepCloneWithObjectId should deep clone object and replace ObjectId with the provided objectId",
                    WithPropertyName = "ObjectId",
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<UpdateCompanyModel>();

                        var referenceObject = A.Dummy<UpdateCompanyModel>().ThatIs(_ => !systemUnderTest.ObjectId.IsEqualTo(_.ObjectId));

                        var result = new SystemUnderTestDeepCloneWithValue<UpdateCompanyModel>
                        {
                            SystemUnderTest = systemUnderTest,
                            DeepCloneWithValue = referenceObject.ObjectId,
                        };
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<UpdateCompanyModel>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<UpdateCompanyModel>().ThatIs(_ => !systemUnderTest.Properties.IsEqualTo(_.Properties));
        ...
        private static readonly UpdateCompanyModel ReferenceObjectForEquatableTestScenarios = A.Dummy<UpdateCompanyModel>();

        private static readonly EquatableTestScenarios<UpdateCompanyModel> EquatableTestScenarios = new EquatableTestScenarios<UpdateCompanyModel>()
            .AddScenario(() =>
                new EquatableTestScenario<UpdateCompanyModel>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new UpdateCompanyModel[]
                    {
                        new UpdateCompanyModel(
                                ReferenceObjectForEquatableTestScenarios.ObjectId,
                                ReferenceObjectForEquatableTestScenarios.Properties),
                    },
                    ObjectsThatAreNotEqualToReferenceObject = new UpdateCompanyModel[]
                    {
                        new UpdateCompanyModel(
                                A.Dummy<UpdateCompanyModel>().Whose(_ => !_.ObjectId.IsEqualTo(ReferenceObjectForEquatableTestScenarios.ObjectId)).ObjectId,
                                ReferenceObjectForEquatableTestScenarios.Properties),
                        new UpdateCompanyModel(
                                ReferenceObjectForEquatableTestScenarios.ObjectId,
                                A.Dummy<UpdateCompanyModel>().Whose(_ => !_.Properties.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Properties)).Properties),
                    },
        ...
        public static class Structural
        {
            ...
            public static void UpdateCompanyModel___Should_implement_IModel_of_UpdateCompanyModel___When_reflecting()
            {
                // Arrange
                var type = typeof(UpdateCompanyModel);

                var expectedModelMethods = typeof(IModel<UpdateCompanyModel>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<UpdateCompanyModel>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void UpdateCompanyModel___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(UpdateCompanyModel);
        ...
        public static class Cloning
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (UpdateCompanyModel)systemUnderTest.Clone();
            ...
            {
                var propertyNames = new string[] { "ObjectId", "Properties" };
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (UpdateCompanyModel)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach(var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(UpdateCompanyModel).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class Serialization
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<UpdateCompanyModel>();
        ...
        public static class Equality
        {
            ...
            {
                // Arrange
                UpdateCompanyModel systemUnderTest1 = null;
                UpdateCompanyModel systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    UpdateCompanyModel systemUnderTest = null;
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_UpdateCompanyModel___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_UpdateCompanyModel___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_UpdateCompanyModel___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_UpdateCompanyModel___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_UpdateCompanyModel___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
