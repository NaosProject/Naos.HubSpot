    ...
    public static partial class PropertyModelTest
    {
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<PropertyModel>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<PropertyModel>().ThatIs(_ => !systemUnderTest.Value.IsEqualTo(_.Value));
        ...
        public static class Structural
        {
            ...
            public static void PropertyModel___Should_implement_IModel_of_PropertyModel___When_reflecting()
            {
                ...
                var expectedModelMethods = typeof(IModel<PropertyModel>)
        ...
        public static class Cloning
        {
            ...
            public static void DeepCloneWith___Should_deep_clone_object_and_replace_the_associated_property_with_the_provided_value___When_called()
            {
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    {
                        var property = typeof(PropertyModel).GetProperty(propertyName);
