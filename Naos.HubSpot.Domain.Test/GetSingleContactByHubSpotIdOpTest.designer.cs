...
namespace Naos.HubSpot.Domain.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<GetSingleContactByHubSpotIdOp> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<GetSingleContactByHubSpotIdOp>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<GetSingleContactByHubSpotIdOp>
                {
                    Name = "Default Code Generated Scenario",
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<GetSingleContactByHubSpotIdOp>();

                        var result = new SystemUnderTestExpectedStringRepresentation<GetSingleContactByHubSpotIdOp>
                        {
                            SystemUnderTest = systemUnderTest,
                            ExpectedStringRepresentation = Invariant($"Naos.HubSpot.Domain.GetSingleContactByHubSpotIdOp: HubSpotId = {systemUnderTest.HubSpotId?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}."),
                        };
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<GetSingleContactByHubSpotIdOp> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<GetSingleContactByHubSpotIdOp>()
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<GetSingleContactByHubSpotIdOp>
                {
        ...
        private static readonly ConstructorPropertyAssignmentTestScenarios<GetSingleContactByHubSpotIdOp> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<GetSingleContactByHubSpotIdOp>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<GetSingleContactByHubSpotIdOp>
                {
                    Name = "HubSpotId should return same 'hubSpotId' parameter passed to constructor when getting",
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        var referenceObject = A.Dummy<GetSingleContactByHubSpotIdOp>();

                        var result = new SystemUnderTestExpectedPropertyValue<GetSingleContactByHubSpotIdOp>
                        {
                            SystemUnderTest = new GetSingleContactByHubSpotIdOp(
        ...
        private static readonly DeepCloneWithTestScenarios<GetSingleContactByHubSpotIdOp> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<GetSingleContactByHubSpotIdOp>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<GetSingleContactByHubSpotIdOp>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<GetSingleContactByHubSpotIdOp>().ThatIs(_ => !systemUnderTest.HubSpotId.IsEqualTo(_.HubSpotId));

                        var result = new SystemUnderTestDeepCloneWithValue<GetSingleContactByHubSpotIdOp>
                        {
                            SystemUnderTest = systemUnderTest,
        ...
        private static readonly GetSingleContactByHubSpotIdOp ReferenceObjectForEquatableTestScenarios = A.Dummy<GetSingleContactByHubSpotIdOp>();

        private static readonly EquatableTestScenarios<GetSingleContactByHubSpotIdOp> EquatableTestScenarios = new EquatableTestScenarios<GetSingleContactByHubSpotIdOp>()
            .AddScenario(() =>
                new EquatableTestScenario<GetSingleContactByHubSpotIdOp>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new GetSingleContactByHubSpotIdOp[]
                    {
                        new GetSingleContactByHubSpotIdOp(
                                ReferenceObjectForEquatableTestScenarios.HubSpotId),
                    },
                    ObjectsThatAreNotEqualToReferenceObject = new GetSingleContactByHubSpotIdOp[]
                    {
                        new GetSingleContactByHubSpotIdOp(
                                A.Dummy<GetSingleContactByHubSpotIdOp>().Whose(_ => !_.HubSpotId.IsEqualTo(ReferenceObjectForEquatableTestScenarios.HubSpotId)).HubSpotId),
                    },
        ...
        public static class Structural
        {
            ...
            {
                // Arrange
                var type = typeof(GetSingleContactByHubSpotIdOp);

                var expectedModelMethods = typeof(IModel<GetSingleContactByHubSpotIdOp>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<GetSingleContactByHubSpotIdOp>));
        ...
        public static class Cloning
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (GetSingleContactByHubSpotIdOp)systemUnderTest.Clone();
            ...
            public static void DeepCloneWith___Should_deep_clone_object_and_replace_the_associated_property_with_the_provided_value___When_called()
            {
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (GetSingleContactByHubSpotIdOp)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach(var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(GetSingleContactByHubSpotIdOp).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class Serialization
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<GetSingleContactByHubSpotIdOp>();
        ...
        public static class Equality
        {
            ...
            {
                // Arrange
                GetSingleContactByHubSpotIdOp systemUnderTest1 = null;
                GetSingleContactByHubSpotIdOp systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    GetSingleContactByHubSpotIdOp systemUnderTest = null;
            ...
            public static void Equals_with_ReturningOperationBase___Should_return_false___When_parameter_other_is_null()
            {
                ...
                {
                    // Arrange
                    ReturningOperationBase<Contact> systemUnderTest = null;

                    // Act
                    var actual = scenario.ReferenceObject.Equals((ReturningOperationBase<Contact>)systemUnderTest);
            ...
            public static void Equals_with_ReturningOperationBase___Should_return_true___When_parameter_other_is_same_object()
            {
                ...
                {
                    // Arrange, Act
                    var actual = scenario.ReferenceObject.Equals((ReturningOperationBase<Contact>)scenario.ReferenceObject);
            ...
            public static void Equals_with_ReturningOperationBase___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                ...
                {
                    // Arrange, Act
                    var actuals = scenario.ObjectsThatDeriveFromScenarioTypeButAreNotOfTheSameTypeAsReferenceObject.Select(_ => scenario.ReferenceObject.Equals((ReturningOperationBase<Contact>)_)).ToList();
            ...
            public static void Equals_with_ReturningOperationBase___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                ...
                {
                    // Arrange, Act
                    var actuals = scenario.ObjectsThatAreNotEqualToReferenceObject.Select(_ => scenario.ReferenceObject.Equals((ReturningOperationBase<Contact>)_)).ToList();
            ...
            public static void Equals_with_ReturningOperationBase___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                ...
                {
                    // Arrange, Act
                    var actuals = scenario.ObjectsThatAreEqualToButNotTheSameAsReferenceObject.Select(_ => scenario.ReferenceObject.Equals((ReturningOperationBase<Contact>)_)).ToList();
