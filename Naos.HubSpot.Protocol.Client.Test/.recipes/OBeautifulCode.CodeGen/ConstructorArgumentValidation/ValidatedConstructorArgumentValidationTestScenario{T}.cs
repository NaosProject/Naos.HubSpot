...
namespace OBeautifulCode.CodeGen.ModelObject.Recipes
{
        ...
        where T : class
    {
            ...
            string expectedExceptionMessageEquals)
        {
            ...
            expectedExceptionType.IsAssignableTo(typeof(Exception)).AsTest(Invariant($"{nameof(expectedExceptionType)}.{nameof(global::OBeautifulCode.Type.Recipes.TypeExtensions.IsAssignableTo)}(typeof({nameof(Exception)}))")).Must().BeTrue();
