...
namespace Naos.HubSpot.Protocol.Client
{
    ...
    public partial class HubSpotProtocol : ISyncAndAsyncVoidProtocol<UpdateCompaniesOp>
    {
        ...
        public async Task ExecuteAsync(UpdateCompaniesOp operation)
        {
            ...
            {
                string rawObjectId = company.Properties.Single(_ => _.Key == StandardCompanyPropertyName.HubSpotId.ToString().ConvertFromCompanyStandardNameToCompanyHubSpotNameIfNecessary()).Value;
                ...
                // Get properties that are not ObjectID or HubSpotID
